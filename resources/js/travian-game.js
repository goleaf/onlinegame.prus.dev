...
window.TravianGame = {
  ...
  handleBuildingCompleted(event) {
    ...
    this.showNotification(
      `Building completed: ${event.detail.building_name}`,
      'success'
    );
  ...
  initializeResourceManager() {
    const resourceManager = document.querySelector(
      '[wire\\:id*="resource-manager"]'
    );
    if (resourceManager) {
  ...
  initializeVillageManager() {
    const villageManager = document.querySelector(
      '[wire\\:id*="village-manager"]'
    );
    if (villageManager) {
  ...
  initializeGameDashboard() {
    const gameDashboard = document.querySelector(
      '[wire\\:id*="game-dashboard"]'
    );
    if (gameDashboard) {
