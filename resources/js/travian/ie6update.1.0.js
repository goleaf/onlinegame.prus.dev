...
(function ($) {
  $.fn.activebar = function (options) {
    ...
    $.fn.activebar.container.css(
      'top',
      '-' + $.fn.activebar.container.height() + 'px'
    );
    ...
    if (options.preload) {
      ...
      $('<img src="' + options.icons_path + 'icon.png" class="normal">').load(
        function () {
          load.a = 1;
          preloadInit();
        }
      ...
      $(
        '<img src="' + options.icons_path + 'icon-over.png" class="normal">'
      ).load(function () {
        load.b = 1;
        preloadInit();
      });
      $('<img src="' + options.icons_path + 'close.png" class="normal">').load(
        function () {
          load.c = 1;
          preloadInit();
        }
      ...
      $(
        '<img src="' + options.icons_path + 'close-over.png" class="normal">'
      ).load(function () {
        load.d = 1;
        preloadInit();
      });
  ...
  $.fn.activebar.defaults = {
    ...
    fontSize: '11px',
    icons_path: 'images/',
    url: '../www.microsoft.com/windows/internet-explorer/default.aspx',
    preload: true,
  };
  ...
  function initializeActivebar(options) {
      ...
      $(window)
        .scroll(function () {
          ...
          if ($.fn.activebar.state == 3) {
            ...
            container.css(
              'top',
              $(window).scrollTop() - container.height() + 'px'
            );
          }
        })
        .resize(function () {
    ...
    container.append(
      $('<div></div>')
        ...
        .append(
          '<img src="' + options.icons_path + 'icon-over.png" class="hover">'
        )
    );
    ...
    container.append(
      $('<div></div>')
        ...
        .append(
          '<img src="' + options.icons_path + 'close.png" class="normal">'
        )
        .append(
          '<img src="' + options.icons_path + 'close-over.png" class="hover">'
        )
    );
  ...
  function setOptionsOnContainer(container, options) {
    ...
    container.hover(
      function () {
        $(this)
          .css({ backgroundColor: options.highlight, color: '#FFFFFF' })
          .addClass('hover');
      ...
      function () {
        $(this)
          .css({ backgroundColor: options.background, color: '#000000' })
          .removeClass('hover');
        $('.hover', container).hide();
