...
ZeroClipboard.Client.prototype = {
  ...
  glue: function (elem, appendElem, stylesToAdd) {
    ...
    this.div.setAttribute('class', 'CopyToClipBoardOverlay');
  ...
  getHTML: function (width, height) {
    ...
    if (navigator.userAgent.match(/MSIE/)) {
      ...
      html +=
        ...
        protocol +
        'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0/#version=9,0,0,0/default.htm' +
        protocol +
        'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0/download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="' +
        width +
        '" height="' +
        height +
        '" id="' +
