...
return [
    ...
    |
    */
    'queue' => env('SIMPLE_MQ_QUEUE', 'game_events'),
    ...
    */
    'queues' => [
        ...
        'game_events' => [
            ...
            'arguments' => [
                /**
                 * Sets the time-to-live for messages in this queue to 1 hour.
                 *
                 * 1 min = 60000
                 * 1 hour = 3600000
                 * 1 day = 3600000 * 24
                ...
                // Limits the maximum number of messages in the queue to 10000 for game events.
                'x-max-length' => 10000,
