...
class QuestManager extends Component
{
    ...
    public function loadQuestData()
    {
        ...
        try {
            ...
            // Load active quests
            $this->activeQuests = $player->quests()
                ->where("status", "active")
                ->with("quest")
                ->get()
                ->toArray();
            ...
            $this->completedQuests = $player->quests()
            ...
            // Load achievements
            $this->achievements = Achievement::where("world_id", $this->world->id)
                ->where("is_active", true)
                ->get()
                ->toArray();

            // Load player achievements
            $this->playerAchievements = $player->achievements()
                ->with("achievement")
                ->get()
                ->toArray();
