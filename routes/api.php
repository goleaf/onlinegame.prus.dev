...
Route::middleware('auth:sanctum')->prefix('game')->group(function () {
    ...
    Route::prefix('battles')->group(function () {
        ...
        Route::get('/statistics', [BattleController::class, 'statistics']);
        Route::get('/leaderboard', [BattleController::class, 'leaderboard']);
    ...
    Route::prefix('quests')->group(function () {
        ...
        Route::get('/achievements', [QuestController::class, 'achievements']);
        Route::get('/achievements/leaderboard', [QuestController::class, 'achievementLeaderboard']);
