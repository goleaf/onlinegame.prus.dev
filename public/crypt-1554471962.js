window.Travian = {
  ...
  ajax: function (options) {
    ...
    if (options.data && typeof options.data === 'object') {
      options.data.ajaxToken =
        typeof Travian.motorCosmetologyRioted === 'function'
          ? Travian.motorCosmetologyRioted()
          : undefined;
      if (options.data.cmd) {
        options.url =
          options.url +
  ...
  isToggleClosed: function (d, c) {
    ...
    var a = d.hasClass('hide'),
      e = a && c.hasClass('switchClosed');
    if (b) {
    ...
    jQuery('.disableButtonHandler').each(function (a, b) {
      ...
      if (b.css('display') === 'none' || b.css('visibility') === 'hidden') {
        b.find('button').each(function (c, d) {
          d = jQuery(d);
          var e =
            d.attr('olddisabled') === undefined
              ? d.attr('disabled') === 'true'
              : d.attr('olddisabled') !== 'false';
...
Travian.Draggable = function (b, a) {
  ...
  this.start = function (c) {
    if (
      this.options.unDraggableTags.indexOf(c.target.getAttribute('tag')) !== -1
    ) {
      return;
    }
    var m = this.options;
    ...
    var h,
      k,
      d = this.offsetParent === window ? null : this.offsetParent;
  ...
  this.check = function (c) {
    ...
    var d = Math.round(
      Math.sqrt(
        Math.pow(c.pageX - this.mouse.start.x, 2) +
          Math.pow(c.pageY - this.mouse.start.y, 2)
      )
    );
    ...
    for (var d in c.modifiers) {
      if (c.modifiers.hasOwnProperty(d)) {
        ...
        if (c.limit && this.limit[d]) {
          if (
            (this.limit[d][1] || this.limit[d][1] === 0) &&
            this.value.now[d] > this.limit[d][1]
          ) {
            this.value.now[d] = this.limit[d][1];
          } else {
            if (
              (this.limit[d][0] || this.limit[d][0] === 0) &&
        ...
        if (c.grid[d]) {
          this.value.now[d] -=
            (this.value.now[d] - (this.limit[d][0] || 0)) % c.grid[d];
        }
        if (c.style) {
...
Travian.Moveable = function (b, a) {
  ...
  this.calculateLimit = function () {
    var o = this.element,
      j = this.container,
      i = jQuery(o.parent() || document.body),
      m = j.getCoordinates(i),
      h = {},
      g = {},
      p = {},
      l = {},
      r = {},
      f = { x: i.scrollTop(), y: i.scrollLeft() };
    ...
    var k = o.offsetWidth + h.left + h.right,
      u = o.offsetHeight + h.top + h.bottom,
      n = 0 + f.x,
      q = 0 + f.y,
      t = m.right - l.right - k + f.x,
      e = m.bottom - l.bottom - u + f.y;
  ...
  this.checkDroppables = function () {
    var e = this.droppables
      .filter(function (h, g) {
        h = this.positions
          ? this.positions[g]
          : this.getDroppableCoordinates(h);
...
function removeNsEvent(c) {
  if (
    typeof this.bindCache === 'undefined' ||
    !this.bindCache.hasOwnProperty(c)
  ) {
    return this;
  }
  var b = c.split('.')[0],
...
Travian.Cookie = {
  ...
  set: function (d, e, b) {
    ...
    document.cookie =
      encodeURIComponent(d) + '=' + encodeURIComponent(e) + a + '; path=/';
  },
  remove: function (a) {
...
Travian.Storage = (function () {
  ...
  var b = function () {
    if (c === null) {
      c = jQuery('input')
        .css({ type: 'hidden', behavior: 'url(#default#userData)' })
        .appendTo('body');
    }
    return c;
  };
  ...
  return Object.create({
    ...
    updateContent: function (g) {
      ...
      if (this.lastText !== f.text || this.lastTitle !== f.title) {
        ...
        var d = Math.max(
          Math.floor(jQuery('body').width() * this.options.maxWidthInPercent),
          this.options.minWidthInPixels
        );
...
Travian.Dialog.Dialog = function (a) {
  ...
  this.correctDialogPosition = function (c) {
    var b = Travian.WindowManager.width,
      i = Travian.WindowManager.height,
      h = this.wrapper.width(),
      d = this.wrapper.height(),
      g = c.left,
      f = c.top,
      e = jQuery(document).scrollTop() || 0;
    if (g < 0) {
      g = 0;
    } else {
      if (g + h >= b) {
  ...
  this.render = function () {
    ...
    if (this.options.savePositionForSession.preferenceKey) {
      var d = Travian.Game.Preferences.get(
        this.options.savePositionForSession.preferenceKey
      );
      if (d !== null) {
        d = JSON.parse(d);
    ...
    c.attr('type', 'submit');
    this.wrapper = jQuery('<div class="dialogWrapper"></div>').css({
      position: 'absolute',
      opacity: 0,
    });
    this.wrapper.html(
      '<div class="dialog ' +
        ...
        '"><div class="dialog-container"><div class="dialog-background-tl"></div><div class="dialog-background-tr"></div><div class="dialog-background-tc"></div><div class="dialog-background-ml"></div><div class="dialog-background-mr"></div><div class="dialog-background-mc"></div><div class="dialog-background-bl"></div><div class="dialog-background-br"></div><div class="dialog-background-bc"></div><div class="dialog-contents"><form action="?" method="get" accept-charset="UTF-8"><div class="dialog-dragbar"><div class="dragbar-inner-left"></div><div class="dragbar-inner-mid"></div><div class="dragbar-inner-right"></div></div><div class="iconButton small info"></div><div id="dialogCancelButton" class="iconButton small cancel"></div><div class="title"></div><div class="content" id="dialogContent"></div><div class="buttons">' +
        f.html() +
      ...
      new Travian.Moveable(this.wrapper, {
        ...
        onDrop: function (h) {
          ...
          if (e.options.savePositionForSession.preferenceKey !== null) {
            e.options.savePositionForSession.position =
              e.correctDialogPosition(g);
          }
        },
        onDrag: function (h) {
          var g = jQuery(h);
  ...
  this.setContent = function (e, c) {
    ...
    if (
      this.options.resizeDialogIfOverflow &&
      Math.floor(d * this.options.maxWidthInPercent) < b
    ) {
  ...
  this.calculatePosition = function () {
    ...
    var d = {
      left: f.x + c.x + j.x / 2 - h.width / 2,
      top: f.y + c.y + j.y / 2 - h.height / 2,
    };
  ...
  this.updatePosition = function (f, e) {
    ...
    if (
      this.options.savePositionForSession.preferenceKey &&
      this.options.savePositionForSession.position &&
      (typeof e === 'undefined' || !e)
    ) {
      this.setPosition(this.options.savePositionForSession.position);
    } else {
      if (
        this.options.dragPosition &&
        typeof this.options.dragPosition.x !== 'undefined' &&
        typeof this.options.dragPosition.y !== 'undefined'
      ) {
  ...
  this.bringToFront = function () {
    ...
    if (
      Travian.WindowManager.getCurrentZIndex() ===
      parseInt(this.wrapper.css('zIndex'))
    ) {
      return false;
    }
...
Travian.Dialog.Dialog.prototype.show = function () {
  ...
  this.animateFunction(
    this.wrapper,
    this.options.fx.open,
    this.options.fx.duration,
    b
  );
  if (this.overlay) {
    this.overlay.open();
  ...
  if (
    c.buttonOk &&
    c.options.buttonTextOk === Travian.Translation.get('allgemein.ok')
  ) {
    if (!Travian.isMobile()) {
      try {
...
Travian.Dialog.Dialog.prototype.close = function (a) {
  ...
  if (
    ...
    Travian.Game.Preferences.set(
      this.options.savePositionForSession.preferenceKey,
      JSON.stringify(this.options.savePositionForSession)
    );
  }
  Travian.Tip.hide();
...
Travian.WindowManager = {
  ...
  getWindowDimensions: function () {
    var a = Travian.WindowManager.width,
      b = Travian.WindowManager.height;
...
Travian.RestoreWindowManager = {
  ...
  initialize: function () {
    jQuery(function () {
      var b = Travian.Game.Preferences.get(
        Travian.RestoreWindowManager.preferenceKey
      );
      if (b === null) {
        return false;
      }
      ...
      for (var a = 0; a < b.length; a++) {
        if (
          b[a].options.stickToUrlOnRestore &&
          b[a].options.dialogOrigin !== location.pathname
        ) {
          return false;
        }
      ...
      Travian.WindowManager.eachWindow(function (b) {
        if (b.options.saveOnUnload) {
          ...
          if (b.options.savePositionForSession.preferenceKey !== null) {
            Travian.Game.Preferences.set(
              b.options.savePositionForSession.preferenceKey,
              JSON.stringify(b.options.savePositionForSession)
            );
          }
        }
      });
...
Travian.Dialog.Ajax = function (a) {
  ...
  if (typeof a.preview !== 'undefined' && a.preview.enabled) {
    var b = a.preview;
    this.setContent(document.getElementById(b.contentElement).html())
      .setTitle(b.title)
      .setInfoIcon(b.infoIcon)
      .updateCssClass(b.dialogCSSClass)
      .show();
    b.onShow(this);
  } else {
    this.request();
...
var Digitarald = {
  AutoCompleter: function (b, a) {
            ...
            if (!this.prefetch() && this.queryValue !== null) {
              ...
              var g = this.selected
                ...
                : f
                  ...
                  : 'first';
              this.choiceOver(
                (this.selected || this.choices.find('li'))[g](
    ...
    this.setSelection = function (j) {
      var k = this.selected.attr('data-value'),
        l = k;
      var e = this.searchFor.length,
        g = k.length;
      ...
      if (this.options.multiple) {
        ...
        l =
          l.substr(0, this.queryIndex) +
          k +
          l.substr(this.queryIndex + f.length);
        if (j) {
    ...
    this.showChoices = function () {
      var h = this.options.choicesMatch,
        k = this.choices.children("li[value='" + h + "']").first();
      ...
      if (
        ...
        this.typeAhead ||
        k.inputValue === this.searchFor
      ) {
        this.choiceOver(k, this.typeAhead);
      }
      var g = this.choices.children("li[value='" + h + "']"),
    ...
    this.prefetch = function () {
      ...
      if (h.length < this.options.minLength) {
        ...
        if (
          h === this.searchFor ||
          (this.visible && i === this.selectedValue)
        ) {
          if (this.visible) {
            return false;
          }
    ...
    this.choiceOver = function (g, h) {
      ...
      if (this.overflown) {
        var j = this.selected.position(),
          i = this.options.overflowMargin,
          k = this.choices.scrollTop,
          e = this.choices.offsetHeight,
          f = k + e;
        if (j.top - i < k && k) {
    ...
    this.filter = function (e) {
      return (e || this.tokens).filter(
        function (f) {
          return this.test(f);
        },
        new RegExp(
          (this.options.filterSubset ? '' : '^') +
            this.escapeRegExp(this.searchFor),
          this.options.filterCase ? '' : 'i'
        )
      );
    };
    this.markQueryValue = function (e) {
      return !this.options.markQuery || !this.searchFor
        ? e
        : e.replace(
            new RegExp(
              '(' +
    ...
    this.Observer = function (g, e, f) {
      ...
      this.changed = function () {
        ...
        this.clear();
        this.value = h;
        this.timeout = setTimeout(this.onFired, this.delay, [
          this.value,
          this.element,
        ]);
      };
    ...
    this.choices =
      c.length > 0
        ...
        : jQuery('<ul/>')
            ...
            .css({ zIndex: this.options.zIndex, display: 'none' })
            .appendTo('body');
    this.element = b
      .prop('autocomplete', 'off')
      .on('keydown', this.onCommand.bind(this))
      .on('click', this.onCommand.bind(this, false))
      .on('focusout', this.hideChoices.bind(this, true));
...
Travian.Form.Element.Input.prototype = Object.create(
  Travian.Form.Element.prototype
);
...
Travian.Form.Element.Input.Button.prototype = Object.create(
  Travian.Form.Element.Input.prototype
);
Travian.Form.Element.Input.Button.constructor =
  Travian.Form.Element.Input.Button;
...
Travian.Form.Element.Input.Checkbox.prototype = Object.create(
  Travian.Form.Element.Input.prototype
);
Travian.Form.Element.Input.Checkbox.constructor =
  Travian.Form.Element.Input.Checkbox;
...
Travian.Form.Element.Input.Radio.prototype = Object.create(
  Travian.Form.Element.Input.prototype
);
...
Travian.Form.Element.Input.Text.prototype = Object.create(
  Travian.Form.Element.Input.prototype
);
...
Travian.Form.Element.Input.Textarea.prototype = Object.create(
  Travian.Form.Element.Input.prototype
);
Travian.Form.Element.Input.Textarea.constructor =
...
Travian.Formatter = function (a) {
  ...
  this.getFormattedNumber = function (d) {
    ...
    e = this.typeFunctions[this.options.formatType].createNumberFunction(
      g,
      this.options
    );
    if (c === true) {
  ...
  this.languageDefinitions = {
    ...
    2: {
      decimalSeperator: '.',
      type: 'type2',
      languages: ['bs-BA-Latn', 'en-US', 'ja-JP', 'ms-MY', 'th-TH', 'com'],
    },
    3: {
      decimalSeperator: ',',
      type: 'type3',
...
Travian.Seasons.Winter = function () {
  ...
  this.updateState = function () {
    ...
    if (this.snowSettings.enabled && f) {
      ...
      d.prepend(
        '<canvas id="snowAnimation" class="' +
          g +
          '" width="' +
          this.snowSettings.screenWidth +
          '" height="' +
          this.snowSettings.screenHeight +
          '"></canvas>'
      );
      ...
      for (var h = 0; h < this.snowSettings.maxFlakes; h++) {
        this.snowFlakes.push({
          x: parseFloat(
            (Math.random() * this.snowSettings.screenWidth).toFixed(2)
          ),
          y: parseFloat(
            (Math.random() * this.snowSettings.screenHeight).toFixed(2)
          ),
          radius: parseFloat(
            (Math.random() * this.snowSettings.maxFlakeRadius).toFixed(2)
          ),
          density: parseFloat(
            (Math.random() * this.snowSettings.maxDensity).toFixed(2)
          ),
        });
      }
  ...
  this.updateSnowFlakePositions = function () {
    ...
    for (var f = 0; f < c.snowFlakes.length; f++) {
      ...
      e.y = parseFloat(
        (e.y + Math.cos(c.wind + e.density) + 1 + e.radius / 2).toFixed(2)
      );
      if (
        e.y + e.radius > c.snowSettings.screenHeight ||
        e.x + e.radius < e.radius * -1 ||
        e.x + e.radius > c.snowSettings.screenWidth + e.radius
      ) {
        if (f % d > 0) {
  ...
  this.drawTheSnow = function () {
    ...
    c.context.clearRect(
      0,
      0,
      c.snowSettings.screenWidth,
      c.snowSettings.screenHeight
    );
    c.context.beginPath();
    var d;
    var g = c.context;
  ...
  this.setState = function (e) {
    var d =
      e && jQuery('input[name=option_seasonal_snow_enabled]').is(':checked');
...
Travian.Seasons.Winter.prototype = Object.create(
  Travian.Seasons.Season.prototype
);
...
Travian.Seasons.Winter.writeNewPreferences = function (a) {
  ...
  jQuery('input[name=option_seasonal_snow_preferencesSettings]')
...
Travian.Seasons.Winter.bindSettingsEvents = function (a, b) {
  ...
  b.find('#option_seasonal_snow_maxFlakeRadius').on('change', function () {
    ...
    if (!Travian.Seasons.currentSeason.restarting) {
      setTimeout(function () {
        var d = Travian.Seasons.currentSeason.setPreferences({
          maxFlakeRadius: c,
        });
        Travian.Seasons.Winter.writeNewPreferences(d);
        Travian.Seasons.currentSeason.restart();
...
Travian.Game = {
  ...
  gotoPage: function (c, d, a, b) {
    Travian.ajax({
      data: { cmd: d, data: { page: c, entries: b } },
  ...
  iPopup: function (b, c) {
    ...
    a.setContent(
      '<iframe class="popup" frameborder="0" id="Frame" src="manual.php?typ=' +
        c +
        '&amp;gid=' +
        b +
        '" width="475" height="525" scrolling="no" border="0" allowTransparency="true"></iframe>'
    );
    a.show();
    return false;
  },
  iPopupUrl: function (a, c) {
    ...
    b.setContent(
      '<iframe class="popup" frameborder="0" id="Frame" src="' +
        a +
        '" width="475" height="500" scrolling="yes" border="0" allowTransparency="true"></iframe>'
    );
    b.show();
    return false;
  },
  unitZoom: function (b) {
    ...
    a.setContent(
      '<div class="zoomTop"></div><div class="zoomMiddle"><img src="img/x.gif" class="unitBig u' +
        b +
        'Big" /></div><div class="zoomBottom"></div>'
    );
    a.show();
    return false;
  },
  showEditVillageDialog: function (e, a, c, b) {
    ...
    new Travian.Dialog.Dialog({
      ...
      onOkay: function (f, g) {
        Travian.ajax({
          data: {
            ...
            name: jQuery('input#villageNameInput').val(),
            did: b,
          },
      ...
      .setContent(
        a +
          ' <input type="text" id="villageNameInput" name="villageName" value="' +
          d +
...
Travian.Game.Layout = {
  states: { travian_toggle: ['expanded', 'collapsed'] },
  goldIsUpdating: false,
  toggleBox: function (f, c, j) {
    var g = c + '_' + j;
    var k = this.states[c];
  ...
  loadLayoutButtonTitle: function (a, c, b) {
    Travian.ajax({
      data: { cmd: 'getLayoutButtonTitle', boxId: c, buttonId: b },
      onSuccess: function (e) {
    ...
    if (b && b.hasClass('toggleable')) {
      ...
      if (a.length > 0) {
        if (b.hasClass('collapsed') && a.length > 0) {
          Travian.ajax({
            data: { cmd: 'infoboxSetReaded', infoIds: a },
            onSuccess: function (c) {
              jQuery('#sidebarBoxInfobox li.unreaded').removeClass('unreaded');
              if (typeof c.messageCounterContent !== 'undefined') {
                jQuery('#sidebarBoxInfobox span.messageShortInfo').html(
                  c.messageCounterContent
                );
              }
            },
          });
      ...
      onSuccess: function (d) {
        ...
        if (c !== a) {
          ...
          if (typeof b === 'function') {
            ...
            if (
              typeof b === 'string' &&
              typeof b.split('.').reduce(function (f, e) {
                return f[e];
              }, window) === 'function'
            ) {
...
Travian.Game.ColorPicker = function (a, b) {
  this.selectColor = function (c) {
    var d = this;
    this.container
      .find('div.moocolorcheckbox-container')
      .removeClass(d.options.selectedClassName);
  ...
  this.draw = function () {
    ...
    this.options.colors.forEach(function (d) {
      var e = jQuery('<div/>')
        .addClass(c.options.className + ' moocolorcheckbox-container')
...
Travian.Game.AddLine = function (a) {
  ...
  'template add insert'.split(' ').forEach(function (c) {
    if (!b.options.elements[c]) {
      b.options.elements[c] = b.options.elements.table.find(
        b.options.selectors[c]
      );
    }
    if (!b.options.elements[c]) {
  ...
  this.options.elements.add.on('click', function (g) {
    ...
    d.each(function (e, h) {
      if (h.tagName.toLowerCase() === 'input') {
        if (
          h.type.toLowerCase() === 'checkbox' ||
          h.type.toLowerCase() === 'radio'
        ) {
          h.tagName.checked = false;
        } else {
          if (
            h.type.toLowerCase() === 'text' ||
            h.type.toLowerCase() === 'password'
          ) {
            h.tagName.value = '';
          }
        }
    ...
    if (
      b.options.maxEntries !== false &&
      b.options.maxEntries === b.options.entryCount
    ) {
    ...
    Object.assign(
      {
        ...
        emptyChoices: function () {
          jQuery('<li />')
            .html(
              Travian.Translation.translate('{cropfinder.keine_ergebnisse}')
            )
...
Travian.Game.AutoCompleter.prototype = Object.create(
  Digitarald.AutoCompleter.prototype
);
...
Travian.Game.AutoCompleter.UserName.prototype = Object.create(
  Travian.Game.AutoCompleter.prototype
);
Travian.Game.AutoCompleter.UserName.constructor =
  Travian.Game.AutoCompleter.UserName;
Travian.Game.AutoCompleter.VillageName = function (a) {
  Travian.Game.AutoCompleter.call(this, a, 'villagename', { maxChoices: 20 });
};
Travian.Game.AutoCompleter.VillageName.prototype = Object.create(
  Travian.Game.AutoCompleter.prototype
);
Travian.Game.AutoCompleter.VillageName.constructor =
  Travian.Game.AutoCompleter.VillageName;
Travian.Game.Messages = {
  check_in_progress: false,
  recipients_checked: false,
  addressBookInstance: null,
  checkRecipients: function (b, a) {
    if (!Travian.Game.Messages.check_in_progress) {
      Travian.Game.Messages.check_in_progress = true;
      Travian.ajax({
        data: { cmd: 'checkRecipient', recipients: b },
        onComplete: function () {
  ...
  showAddressBook: function () {
    if (Travian.Game.Messages.addressBookInstance === null) {
      Travian.Game.Messages.addressBookInstance =
        new Travian.Game.Messages.AddressBook('#adressbook');
    }
...
Travian.Game.Messages.AddressBook.prototype = Object.create(
  Travian.Dialog.Dialog.prototype
);
...
Travian.Game.BBEditor = function (b, a) {
  ...
  this.initialize = function (d, c) {
    ...
    jQuery('#' + d + '_previewButton').on(
      'click',
      jQuery.proxy(function (f) {
        e.fetchPreview(f);
      }, e)
    );
    jQuery('#' + d + '_resourceButton').on(
      'click',
      jQuery.proxy(function (f) {
        e.showToolbarWindow(f);
      }, e)
    );
    jQuery('#' + d + '_smilieButton').on(
      'click',
      jQuery.proxy(function (f) {
        e.showToolbarWindow(f);
      }, e)
    );
    jQuery('#' + d + '_troopButton').on(
      'click',
      jQuery.proxy(function (f) {
        e.showToolbarWindow(f);
      }, e)
    ...
    switch (Travian.Game.BBEditor.getInformationFromClass(d[0], 'bbType')) {
      ...
      case 'o':
        g.insertAtCursor(
          this.textArea,
          '[' +
            Travian.Game.BBEditor.getInformationFromClass(d[0], 'bbTag') +
            ']'
        );
        break;
    }
  ...
  this.showToolbarWindow = function (h) {
    ...
    var d = jQuery(
      '#' +
        g.id +
        '_' +
        Travian.Game.BBEditor.getInformationFromClass(f, 'bbWin')
    );
    var c = true;
  ...
  this.fetchPreview = function (d) {
    ...
    Travian.ajax({
      data: { cmd: 'bb', nl2br: 1, target: c.id, text: c.textArea.val() },
      onSuccess: function (e) {
        c.showPreview(e);
      },
    });
...
Travian.Game.RaidList = {
  ...
  editSlot: function (b, c, a, d) {
    ...
    Travian.ajax({
      ...
      onSuccess: function (f) {
        e.dialog(
          { buttonOk: false, context: 'raidAddSlotDialog', raidListId: b },
          f.html
        );
        return true;
      },
  ...
  deleteSlot: function (b, a) {
    var c = this;
    Travian.ajax({
      data: { cmd: 'raidList', method: 'actionDeleteSlot', slotId: b },
      onSuccess: function () {
        var d =
          Travian.WindowManager.getWindowsByContext('raidAddSlotDialog').pop();
  ...
  dialog: function (a, c) {
    var b = new Travian.Dialog.Dialog(
      Object.assign({ preventFormSubmit: true }, a)
    );
    b.setContent(c);
    b.show();
  },
  ...
  parseQueryString: function (c, f, a) {
    ...
    d.forEach(function (k) {
      var g = k.indexOf('=') + 1,
        i = g ? k.substr(g) : '',
        h = g ? k.substr(0, g - 1).match(/([^\]\[]+|(\B)(?=\]))/g) : [k],
        j = b;
      if (!h) {
        return;
      }
  ...
  saveSlot: function (b, c, d, a) {
    ...
    Travian.ajax({
      data: {
        cmd: 'raidList',
        method: 'ActionCheckForForeignSlotEntry',
        listId: b,
        slotId: c,
        x: d.x,
        y: d.y,
        ...
        if (g.entryExists) {
          ...
          f.setContent(
            '<div class="centeredText">' +
              Travian.Translation.get('raidList.overwriteFarmListEntry') +
              '<br>' +
              Travian.Translation.get(
                'raidList.thisWillOverwriteAnExistingFarmListEntry'
              ) +
              '</div>'
          );
          f.show();
  ...
  persistSlotEntry: function (b, c, f, a) {
    var e = this,
      d = jQuery('#raidListSlot #edit_form .troops');
    ...
    Travian.ajax({
      ...
      onSuccess: function (g) {
        Travian.WindowManager.getWindowsByContext('raidAddSlotDialog')
          .pop()
          .close();
        if (a !== false) {
          var l = null;
          if (
            typeof g != 'undefined' &&
            typeof g.updatedSlotId != 'undefined' &&
            g.updatedSlotId > 0
          ) {
            l = g.updatedSlotId;
          } else {
          ...
          e.refreshList(b);
          if (
            typeof g.updatedFarmListId != 'undefined' &&
            g.updatedFarmListId > 0
          ) {
  ...
  loadList: function (b, a, f) {
    ...
    c.removeClass('hide');
    Travian.ajax({
      data: { cmd: 'raidListSlots', lid: b, sort: a, direction: f },
      onComplete: function () {
        c.addClass('hide');
      },
      onSuccess: function (g) {
        d.find('.listContent').html(g.html).removeClass('hide');
        d.find('.openedClosedSwitch')
          .removeClass('switchClosed')
          .addClass('switchOpened');
        e.data[b] = g.list;
  ...
  showCreateNewList: function () {
    var a = this;
    Travian.ajax({
      data: { cmd: 'raidList', method: 'actionAddListForm' },
      onSuccess: function (b) {
  ...
  showUpdateList: function (a) {
    var b = this;
    Travian.ajax({
      data: { cmd: 'raidList', method: 'actionUpdateListForm', listId: a },
      onSuccess: function (c) {
  ...
  sort: function (a, b) {
    return this.loadList(
      a,
      b,
      this.data[a].directions[b] !== 'asc' ? 'asc' : 'desc'
    );
  },
  ...
  updateListsVisibility: function (a) {
    var f = jQuery('#list' + a),
      e = f.find('.listContent'),
      d = f.find('.openedClosedSwitch'),
      g = false,
      b,
      c;
...
Travian.TimersAndCounters = {
  ...
  initTimersInContext: function (b) {
    var a,
      c = b.getElementsByClassName('timer');
  ...
  executeCounter: function (f) {
    ...
    switch (true) {
      ...
      default:
        window.setTimeout(
          "Travian.TimersAndCounters.executeCounter('" + f + "')",
          b.tickInMs
        );
    }
  ...
  processReload: function (b) {
    ...
    switch (auto_reload) {
      case 0:
        ...
        break;
      case 1:
        a = Travian.WindowManager.checkForModalDialogs()
          ? this.modalReload
          : this.plainReload;
        break;
      case 2:
...
Travian.Game.Hero.Editor = (function () {
  ...
  return function (b) {
    ...
    this.hideAll = function () {
      var c = this.options.element
        .find('.attributes .container .infoOpen')
        .removeClass('infoOpen');
      ...
      if (d !== null) {
        d.on('click', function (f) {
          e.sendAction('save', function () {
            ...
            jQuery('.' + e.options.elementHeroImage).attr(
              'src',
              Travian.composeURI(g)
            );
          });
          f.preventDefault();
        });
    ...
    this.initializeAttributes = function () {
      ...
      this.options.element
        .find('.attributes .container .info .headline')
        .on('click', function (d) {
          d.preventDefault();
          c.showAttribute(jQuery(this).parent('.info'));
        });
      this.options.element
        .find('.attributes .container .attribute')
        .on('click', function (f) {
    ...
    this.sendAction = function (c, e) {
      if (c === 'save') {
        ...
        this.unloadIdentifier = Travian.Form.UnloadHelper.enableSecurity(
          this.unloadIdentifier
        );
      }
      var d = this;
      Travian.ajax({
    ...
    this.switchGender = function (c) {
      if (this.options.element.hasClass('genderSwitch')) {
        jQuery(
          '#heroEditorActivateMale, #heroEditorActivateFemale'
        ).removeClass('iconActive disabled');
        if (c === 'male') {
    ...
    this.bindGenderSwitch = function () {
      var c = this;
      jQuery('#heroEditorActivateMale, #heroEditorActivateFemale').on(
        'click',
        function (d) {
          if (
            jQuery(this).attr('id') === 'heroEditorActivateMale' &&
            c.options.element.hasClass('male') === false
          ) {
            c.switchGender('male');
          } else {
            if (
              jQuery(this).attr('id') === 'heroEditorActivateFemale' &&
              c.options.element.hasClass('female') === false
            ) {
...
Travian.Game.Hero.Inventory = function (a) {
  ...
  this.options = Object.assign(
    {
      ...
      text: {
        moveDialogDescription:
          'Anzahl der zu verschiebenden Items: {inputField}',
  ...
  this.createAndAddItem = function (b) {
    var c = Object.assign(
      { placeElement: undefined, html_id: 'item_' + b.id },
      b || {}
    );
  ...
  this.createDivs = function () {
      ...
      var i = jQuery('<div/>')
        ...
        .addClass(
          'item ' +
            ...
            k.typeId +
            ' ' +
            (k.isUseable ? '' : 'disabled')
        )
        .css('position', 'relative')
        .html('<div class="amount">' + k.amount + '</div>')
        .on({
    ...
    this.makeDraggable();
    this.options.elementHeroBody[0].src = String(
      this.options.urlBodyImage
    ).replace(
      /\\?\{([^{}]+)\}/g,
      jQuery.proxy(this.substitute, { heroBodyHash: e.options.heroBodyHash })
    );
    return this;
  };
  ...
  this.executeMovement = function (e, c, b) {
    ...
    Travian.ajax({
      ...
      onSuccess: function (l) {
        ...
        d.options.heroState = Object.assign(
          d.options.heroState,
          l.heroState || {}
        );
        if (l.heroBodyHash) {
        ...
        for (var h = 1, g = null; h <= n; h++) {
          g = jQuery('<div/>')
            .attr('id', 'inventory_' + h)
            .addClass('inventory draggable')
            .insertBefore(jQuery('#itemsToSale').find('.market'));
        }
        d.createDivs();
        ...
        if (k[0].className !== 'hero-dead') {
          k.find('.experience')
            .find('.value')
            .html(l.heroData.experience.current);
          var m = k.find('.health');
          if (m.length > 0) {
      ...
      if (!Travian.isMobile()) {
        jQuery(f).on('mousedown', function (h) {
          ...
          jQuery('body').on('mousemove.inventoryItem', function (j) {
            ...
            var i = jQuery(g);
            i.offset({
              left: j.pageX - i.width() / 2,
              top: j.pageY - i.height() / 2,
            });
  ...
  this.moveToDrop = function (h, e, c) {
    ...
    if (
      c !== true &&
      !this.isInventoryId(e.attr('id')) &&
      ((h[0].item.instant && h[0].item.amount === 1) || h[0].item.amount > 1)
    ) {
      if (this.options.useOneDialogTitleCallbacks[h[0].item.typeId]) {
        g = Object.assign(
          g,
          this.options.useOneDialogTitleCallbacks[h[0].item.typeId](
            h[0].item,
            this.options,
            g
          ) || {}
...
Travian.Game.Hero.SilverExchange = function (a) {
  ...
  this.initialize = function () {
    ...
    if (this.options.exchangeOptions.showExchangeTypeElement.length > 0) {
      this.assignListenerToShowExchangeType(
        this.options.exchangeOptions.showExchangeTypeElement
      );
    }
    if (
      this.options.exchangeOptions.submitButton.length > 0 &&
    ...
    if (this.options.exchangeOptions.inputElement.length > 0) {
      this.assignListenerToExchangeInput(
        this.options.exchangeOptions.inputElement
      );
    }
  };
      ...
      filterInputTG: function (b) {
        ...
        function d(k) {
          var n = 0,
            ...
            l;
          if (
            typeof k.selectionStart == 'number' &&
            typeof k.selectionEnd == 'number'
          ) {
            n = k.selectionStart;
            i = k.selectionEnd;
          } else {
  ...
  this.assignListenerToExchangeInput = function (b) {
    ...
    var c = function (e) {
      d.hideAllMessages();
      if (
        d.options.exchangeOptions.submitButton.length > 0 &&
        d.options.exchangeOptions.submitButton2 &&
        d.options.exchangeOptions.submitButton2.length > 0
      ) {
  ...
  this.updateExchangeValue = function (h) {
    ...
    if (e.maxAmount !== null && 'function' == typeof b && c > e.maxAmount) {
      ...
      jQuery(
        '#silverExchange .exchangeType' +
          this.options.exchangeOptions.directionType +
          ' input'
      ).val(c);
      f = false;
    } else {
  ...
  this.sendAction = function (d) {
    ...
    Travian.ajax({
      data: { cmd: 'silverExchange', exTyp: g, s: f, g: b },
        ...
        if (i.errorMessage) {
          ...
          var j = function (l) {
            if (l.message) {
              ...
              h.updateExchangeValue(
                jQuery(
                  '#silverExchange .exchangeType' +
                    h.options.exchangeOptions.directionType +
                    ' input'
                ).val()
              );
  ...
  this.overrideGoldAndSilver = function (b, e, h, g) {
    ...
    jQuery('.ajaxReplaceableSilverAmountDiff').each(
      jQuery.proxy(f, { type: 'silver' })
    );
    jQuery('.ajaxReplaceableGoldAmountDiff').each(
      jQuery.proxy(f, { type: 'gold' })
    );
        ...
        onSuccess: function (e) {
          if (e.changed) {
            ...
            jQuery(window).trigger(
              'domAltered',
              jQuery('#horseToggleBox > div.inactive')
            );
            jQuery(window).trigger(
              'domAltered',
              jQuery('#horseToggleBox > div.active')
            );
          }
...
Travian.Game.Hero.Properties.PropertyForm.prototype = Object.create(
  Travian.Form.prototype
);
Travian.Game.Hero.Properties.PropertyForm.constructor =
  Travian.Game.Hero.Properties.PropertyForm;
Travian.Game.Hero.PropertySetter = function (b, a) {
  ...
  this.initialize = function (c) {
    ...
    this.options.elementAvailablePoints = jQuery(
      '#' + this.options.elementAvailablePoints
    );
    this.update();
  };
...
Travian.Game.Hero.PropertySetter.prototype = Object.create(
  Travian.Form.Element.prototype
);
...
Travian.Game.Hero.PropertySetter.Attribute = function (a) {
  ...
  this.initialize = function () {
    var f = this;
    this.options.element = jQuery('#' + this.options.element);
    this.options.elementBtnMinus = this.options.element.find(
      this.options.elementBtnMinus
    );
    this.options.elementBtnPlus = this.options.element.find(
      this.options.elementBtnPlus
    );
    this.options.elementInput = this.options.element.find(
      this.options.elementInput
    );
    this.options.elementProgressBar = this.options.element.find(
      this.options.elementProgressBar
    );
    this.options.elementValue = this.options.element.find(
  ...
  this.updateButtons = function () {
    this.options.elementBtnPlus.toggleClass(
      'disabled',
      this.getTotalPoints() >= this.getMaxPoints() ||
        this.getPropertySetter().getAvailablePoints() === 0
    );
    this.options.elementBtnMinus.toggleClass(
      'disabled',
      this.getSettedPoints() === 0
    );
    return this;
  };
  this.initialize();
};
Travian.Game.Hero.PropertySetter.Attribute.prototype.calculateValue =
  function () {
    return 0;
  };
Travian.Game.Hero.PropertySetter.Attribute.prototype.update = function () {
  this.options.elementValue.html(this.calculateValue());
  this.options.elementInput.val(
    this.options.usedPoints + this.getSettedPoints()
  );
  this.options.elementProgressBar.css(
    'width',
    Math.max(
      0,
      Math.min(
        100,
        Math.round(
          (100 / Math.min(this.getMaxPoints() + 4, 100)) *
            this.getSettedPoints()
        )
      )
    ) + '%'
  );
...
Travian.Game.Hero.PropertySetter.Attribute.Power = function (a) {
  ...
  this.calculateValue = function () {
    return (
      100 +
      this.getTotalPoints() * this.options.valueBonus +
      this.options.valueOfItems
    );
  };
  Travian.Game.Hero.PropertySetter.Attribute.call(this, this.options);
};
Travian.Game.Hero.PropertySetter.Attribute.Power.prototype = Object.create(
  Travian.Game.Hero.PropertySetter.Attribute.prototype
);
Travian.Game.Hero.PropertySetter.Attribute.Power.constructor =
  Travian.Game.Hero.PropertySetter.Attribute.Power;
...
Travian.Game.Hero.PropertySetter.Attribute.OffBonus.prototype = Object.create(
  Travian.Game.Hero.PropertySetter.Attribute.prototype
);
Travian.Game.Hero.PropertySetter.Attribute.OffBonus.constructor =
  Travian.Game.Hero.PropertySetter.Attribute.OffBonus;
...
Travian.Game.Hero.PropertySetter.Attribute.DefBonus.prototype = Object.create(
  Travian.Game.Hero.PropertySetter.Attribute.prototype
);
Travian.Game.Hero.PropertySetter.Attribute.DefBonus.constructor =
  Travian.Game.Hero.PropertySetter.Attribute.DefBonus;
Travian.Game.Hero.PropertySetter.Attribute.ProductionPoints = function (a) {
  ...
  this.getPossibleBonusProductionForResource = function (b) {
    if (b === 0) {
      return (
        this.calculateValue() * this.options.pointWorth[0] * Travian.Game.speed
      );
    }
    if (b <= 4) {
      return (
        this.calculateValue() * this.options.pointWorth[b] * Travian.Game.speed
      );
    }
    return 0;
  };
  this.initialize = function () {
    ...
    if (c.length > 0) {
      c.find('div.resource label:not(.baseCrop) span.current').each(
        function (d) {
  ...
  this.update = function () {
    ...
    return Travian.Game.Hero.PropertySetter.Attribute.prototype.update.call(
      this
    );
  };
  this.initialize();
};
Travian.Game.Hero.PropertySetter.Attribute.ProductionPoints.prototype =
  Object.create(Travian.Game.Hero.PropertySetter.Attribute.prototype);
Travian.Game.Hero.PropertySetter.Attribute.ProductionPoints.constructor =
  Travian.Game.Hero.PropertySetter.Attribute.ProductionPoints;
...
Travian.Game.Hero.PropertySetter.Attribute.RegenBonus.prototype = Object.create(
  Travian.Game.Hero.PropertySetter.Attribute.prototype
);
Travian.Game.Hero.PropertySetter.Attribute.RegenBonus.constructor =
  Travian.Game.Hero.PropertySetter.Attribute.RegenBonus;
  ...
  bindEvents: function () {
    ...
    jQuery('.welcomeScreen .previewVideoContainer').on('click', function () {
      ...
      if (!a.hasClass('heroItemsEnabled')) {
        b =
          '<iframe width="568" height="320" src="https://www.youtube.com/embed/bOtcpFmtO04?rel=0&amp;showinfo=0&amp;autoplay=1" frameborder="0" allowfullscreen></iframe>';
      } else {
        b =
          '<iframe width="568" height="320" src="https://www.youtube.com/embed/fkcrmCTv0d4?rel=0&amp;showinfo=0&amp;autoplay=1" frameborder="0" allowfullscreen></iframe>';
      }
      jQuery('.welcomeScreen .previewVideoContainer').html(b);
      jQuery('.welcomeScreen .welcomeScreenHeader .overlay').addClass('active');
    });
    jQuery('.welcomeScreen .readMore, .welcomeScreen .readLess').on(
      'click',
      function () {
...
Travian.Game.Activation = function () {
  ...
  this.createArrowShapes = function () {
    ...
    for (var b = 0; b < g; b++) {
      a = e + b * h + h / 3.3333;
      d.arrowShapes['tribe' + (b + 1)] = d.basicShape.replace(
        '[ARROW_POSITION]',
        a
      );
    }
  ...
  this.updateArrowPositions = function () {
    ...
    for (var a = 0; a < b.length; a++) {
      if (b[a].checked === true) {
        TweenLite.to(
          jQuery('#presentation svg .inner, #presentation svg .outer'),
          0.25,
...
Travian.Game.Overlay = {
  elementsForOverlay: [
    ...
    },
    {
      ...
      helperOffsetRTLX2: 4,
      members: [
        { selector: '#n1', x1: null, x2: null, y1: null, y2: null },
        { selector: '#n2', x1: null, x2: null, y1: null, y2: null },
      ],
    },
    {
      ...
      helperOffsetRTLX2: -2,
      members: [
        { selector: '#n3', x1: null, x2: null, y1: null, y2: null },
        { selector: '#n4', x1: null, x2: null, y1: null, y2: null },
        { selector: '#n5', x1: null, x2: null, y1: null, y2: null },
        { selector: '#n6', x1: null, x2: null, y1: null, y2: null },
      ],
    },
    {
      ...
      members: [
        { selector: '#n7', x1: null, x2: null, y1: null, y2: null },
        { selector: '#goldSilver', x1: null, x2: null, y1: null, y2: null },
      ],
    },
    {
      groupID: 'outOfGame',
      ...
      members: [
        { selector: '#outOfGame', x1: null, x2: null, y1: null, y2: null },
      ],
    },
    {
    ...
    },
    {
      ...
      offsetY2: 12,
      members: [
        { selector: '#sidebarBoxHero', x1: null, x2: null, y1: null, y2: null },
      ],
    },
    {
  ...
  createOverlay: function () {
    ...
    var a = d.height();
    var b = jQuery(
      '<div id="overlayUI" style="width: ' +
        c +
        'px; height: ' +
        a +
        'px;"><canvas id="overlayUICanvas" width="' +
        c +
        '" height="' +
        a +
        '"></canvas><div class="overlayContent"><div class="overlaySubcontent"><p class="overlayTitle">' +
        e.texts.defaultTitle +
        '</p><p class="overlayDescription">' +
        e.texts.defaultDescription +
        '</p><a class="overlayCloseLink" href="#" onclick="Travian.Game.Overlay.closeOverlay();">' +
        e.texts.closeLink +
        '</a></div></div>'
    ).fadeOut(1);
    ...
    e.scrollOffsetX =
      e.readingDirection === 'rtl' ? Math.abs(c - jQuery(window).width()) : 0;
  },
  ...
  addDarkBackground: function (g) {
    ...
    var b =
      ...
      typeof g.helperOffsetRTLX1 !== 'undefined'
        ? g.helperOffsetRTLX1
        : 0;
    var a =
      this.readingDirection === 'rtl' &&
      typeof g.helperOffsetRTLX2 !== 'undefined'
        ? g.helperOffsetRTLX2
        : 0;
    ...
    jQuery(g.members).each(function (i, j) {
      ...
      if (h.length > 0) {
        if (typeof e === 'undefined') {
          ...
          if (
            f.readingDirection === 'ltr' &&
            h.offset().left < e.offset().left
          ) {
            e = h;
          }
          if (
            f.readingDirection === 'rtl' &&
            h.offset().left > e.offset().left
          ) {
            e = h;
          }
    ...
    if (typeof e !== 'undefined' && e.length > 0) {
      var d = jQuery('<div class="overlayUIBackgroundHelper"></div>')
        .css({
          ...
          height: g.y2 - g.y1,
          'margin-left':
            (typeof g.helperOffsetX1 !== 'undefined'
              ? g.helperOffsetX1
              : g.offsetX1) -
            4 +
            b,
          'margin-right':
            (typeof g.helperOffsetX2 !== 'undefined'
              ? g.helperOffsetX2
              : g.offsetX2) +
            a -
            10 * c,
          'margin-top':
            typeof g.helperOffsetY1 !== 'undefined'
              ? g.helperOffsetY1
              : g.offsetY1,
          'margin-bottom':
            typeof g.helperOffsetY2 !== 'undefined'
              ? g.helperOffsetY2
              : g.offsetY2,
          'z-index': -1,
        })
...
Travian.Game.Highlight.Renderer.Rectangle = function (b, d) {
  ...
  var c = function (k, m) {
    ...
    if (
      m._lastCoordinates &&
      m._lastCoordinates.left === o.left &&
      m._lastCoordinates.top === o.top &&
      m._lastCoordinates.width === o.width &&
      m._lastCoordinates.height === o.height &&
      m._lastCoordinates.right === o.right &&
      m._lastCoordinates.bottom === o.bottom
    ) {
      return;
    }
  ...
  this.activate = function () {
    ...
    c(null, e);
    $(document)
      .find('.openedClosedSwitch')
      .on('click.highlight', { renderer: e }, c);
    if (e.options.draggable) {
      $(document)
        .off('dialogDraggingSync')
        .on('dialogDraggingSync', { renderer: e }, c);
    }
    return this;
  };
  ...
  this.getElementBottom = function () {
    if (this.elements.bottom === null) {
      this.elements.bottom = jQuery('<div />')
        .hide()
        .addClass(this.options.cssClassBottom)
        .css({
          position: 'absolute',
          left: 0,
          top: 0,
  ...
  this.getElementBottomLeft = function () {
    if (this.elements.bottomLeft === null) {
      this.elements.bottomLeft = jQuery('<div />')
        .hide()
        .addClass(this.options.cssClassBottomLeft)
        .css({
          position: 'absolute',
          left: 0,
          top: 0,
  ...
  this.getElementBottomRight = function () {
    if (this.elements.bottomRight === null) {
      this.elements.bottomRight = jQuery('<div />')
        .hide()
        .addClass(this.options.cssClassBottomRight)
        .css({
          position: 'absolute',
          left: 0,
          top: 0,
  ...
  this.getElementLeft = function () {
    if (this.elements.left === null) {
      this.elements.left = jQuery('<div />')
        .hide()
        .addClass(this.options.cssClassLeft)
        .css({
          position: 'absolute',
          left: 0,
          top: 0,
  ...
  this.getElementTop = function () {
    if (this.elements.top === null) {
      this.elements.top = jQuery('<div />')
        .hide()
        .addClass(this.options.cssClassTop)
        .css({
          position: 'absolute',
          left: 0,
          top: 0,
  ...
  this.getElementTopLeft = function () {
    if (this.elements.topLeft === null) {
      this.elements.topLeft = jQuery('<div />')
        .hide()
        .addClass(this.options.cssClassTopLeft)
        .css({
          position: 'absolute',
          left: 0,
          top: 0,
  ...
  this.getElementTopRight = function () {
    if (this.elements.topRight === null) {
      this.elements.topRight = jQuery('<div />')
        .hide()
        .addClass(this.options.cssClassTopRight)
        .css({
          position: 'absolute',
          left: 0,
          top: 0,
  ...
  this.getElementRight = function () {
    if (this.elements.right === null) {
      this.elements.right = jQuery('<div />')
        .hide()
        .addClass(this.options.cssClassRight)
        .css({
          position: 'absolute',
          left: 0,
          top: 0,
  ...
  if (
    this.invalidTypes.indexOf(
      this.getElement().prop('tagName').toLowerCase()
    ) !== -1
  ) {
    throw 'invalid tag type for rectangle-highlighting!';
  }
};
Travian.Game.Highlight.Renderer.Rectangle.prototype = Object.create(
  Travian.Game.Highlight.Renderer.Renderer.prototype
);
Travian.Game.Highlight.Renderer.Rectangle.constructor =
  Travian.Game.Highlight.Renderer.Rectangle;
Travian.Game.Highlight.Renderer.Image = function (a, b) {
  this.elements = { background: null, placeholder: null };
  this.options = Object.assign(
    { borderSurround: 4, cssBackground: 'highlighted background' },
    a
  );
  this.validTypes = ['div', 'span', 'a', 'li', 'img', 'input', 'button'];
  this.activate = function () {
    var c = this.getElement();
    this.getElementBackground()
      .css({
        position: 'absolute',
  ...
  this.getElementBackground = function () {
    if (this.elements.background === null) {
      var c = this.getElement();
      this.elements.background = c
        .clone(false)
        .empty()
        .addClass(this.options.cssBackground)
        .insertBefore(c)
        .hide();
    }
  ...
  if (
    this.validTypes.indexOf(this.getElement().prop('tagName').toLowerCase()) ===
    -1
  ) {
    throw 'invalid tag type for image-highlighting!';
  }
};
Travian.Game.Highlight.Renderer.Image.prototype = Object.create(
  Travian.Game.Highlight.Renderer.Renderer.prototype
);
Travian.Game.Highlight.Renderer.Image.constructor =
  Travian.Game.Highlight.Renderer.Image;
  ...
  this.calculateDurations = function () {
    ...
    Travian.ajax({
      data: {
        ...
        adventureKids: jQuery.map(
          a.find('input[name*=adventureKid]'),
          function (c) {
            return c.value;
          }
        ),
        currentKidAndDid: b,
        originalWalkTimes: jQuery.map(
          a.find('input[name*=adventureWalktimeOriginalVillage]'),
          function (c) {
            return c.value;
          }
        ),
...
Travian.Game.BuildingUpgradeView = {
  initialize: function () {
    jQuery('#build .buildingDescription .headline .openedClosedSwitch').on(
      'click',
      function () {
        var b = jQuery(this);
...
Travian.Game.TrainingTroops = {
  ...
  initialize: function () {
    ...
    a.trainTroopsContainer
      .find('.troop button.favourite')
      .on('click', function () {
        if (!a.isAnimating) {
          a.isAnimating = true;
          var c = jQuery(this);
  ...
  saveFavouriteTroops: function () {
    Travian.Game.Preferences.set(
      'favouriteTroopsInVillage' + this.did,
      this.favouriteTroops.join(',')
    );
  },
...
Travian.Game.Marketplace = function (a) {
  ...
  this.prepare = function () {
    ...
    Travian.ajax({
      ...
      onSuccess: function (e) {
        ...
        if (e.button) {
          jQuery('#button').html(
            '<div id="prepareError" class="error">' +
              jQuery('#prepareError').html() +
              '</div>' +
              e.button +
              '<div class="clear"></div>'
  ...
  this.validateTradeRouteResources = function (b) {
    ...
    if (g > c) {
      h = {
        MERCHANTS_NEEDED: Math.ceil(g / this.capacityPerMerchant),
        MERCHANTS_AVAILABLE: this.merchantsMax,
      };
      e.addClass('error').html(
        Travian.Helpers.substitute(
          Travian.Translation.translate('{notEnoughMerchants}'),
          h,
          /\\?\[([^\[\]]+)\]/g
        )
      );
  ...
  this.validateTradeRouteResourcesSanity = function () {
    ...
    if (d == 0) {
      jQuery('#tradeRouteError')
        .addClass('error')
        .html(Travian.Translation.translate('{resourcesNumberInvalid}'));
      return false;
    }
    return true;
  };
  this.validateTradeRouteSendTime = function () {
    ...
    if (!this.validateTradeRouteSendTimeSanity()) {
      b.addClass('error').html(
        Travian.Translation.translate('{invalidTimeFormat}')
      );
  ...
  this.validateTradeRouteSendTimeSanity = function () {
    ...
    !e &&
      d
        .addClass('error')
        .html(Travian.Translation.translate('{invalidTimeFormat}'));
    return e;
  };
  ...
  this.updateLinks = function () {
    var b;
    for (b = 1; b <= 4; b++) {
      jQuery('#addRessourcesLink' + b).toggleClass(
        'notClickable',
        this.getValueToAddToRessources(b) == 0
      );
    }
  };
  ...
  this.setSelectedRessourcesInfo = function (b) {
    jQuery('#sumResources')
      .toggleClass('notEnoughMerchants', b > this.merchantCapacity)
      .html(b);
  };
...
Travian.Game.Marketplace.onLoad = function () {
  ...
  jQuery('a.sorting#sorting' + a.sortingColumn).addClass(
    a.sortingOrder == 'a' ? 'asc' : 'desc'
  );
};
...
Travian.Game.Marketplace.ExchangeResources = function (a) {
  ...
  this.fillup = function (c) {
    jQuery('input[name="desired[' + c + ']"]').val(
      resources.maxStorage['l' + (c + 1)] || 0
    );
    this.calculateRest();
  };
  ...
  this.distribute = function (e) {
    ...
    var f = this;
    Travian.ajax({
      data: { cmd: 'exchangeResources', did: e, desired: d },
      onSuccess: function (i) {
        c.each(function (k, j) {
        ...
        h.html(
          i.resources.reduce(function (k, j) {
            return k + j;
          }, 0)
        );
        f.calculateRest();
...
Travian.AttackSymbol = {
  markAttackSymbol: function (d) {
    ...
    Travian.ajax({
      data: { cmd: 'markIncomingAttacks', data: { id: d, state: c } },
    });
  },
};
...
Travian.Game.RallyPoint.CoordinatesInputHelper.prototype.insertCoordinates =
  function (b) {
    ...
    if (c !== null) {
      ...
      jQuery('#' + this.options.coordinateYInputId)
        .val(c[2])
        .focus();
    } else {
    ...
    Travian.ajax({
      ...
      onSuccess: function (c) {
        if (c.close || c.html === '') {
          ...
          b.setContent(c.html)
            .setTitle(c.title)
            .setInfoIcon(c.infoIcon)
            .updateCssClass(c.cssClass);
          b.show();
        }
      },
...
Travian.Game.AllianceMembers.prototype = Object.create(
  Travian.Dialog.Ajax.prototype
);
...
Travian.Game.AllianceDonation = {
  ...
  donate: function (b, d, c) {
    ...
    Travian.ajax({
      data: { cmd: 'donateResources', params: c, action: d },
      onSuccess: function (e) {
        if (e.html !== '') {
        ...
        var f = Travian.Game.AllianceDonation.getResourceAnimationSpeed(
          c.amount,
          g
        );
        if (e.newTotal > 0) {
          ...
          Travian.Game.AllianceDonation.refreshProgressBarTitle(
            e.limit - e.newTotal
          );
        }
        if (e.reload === true) {
  ...
  checkAndChangeScalingPopup: function (b, a) {
    ...
    if (b === 'scale') {
      var c = this.toNaturalNumber(
        jQuery('#resourcesUntilLimit')[0].dataset.limit
      );
  ...
  refreshDonationLimitBar: function () {
    ...
    a.addClass('hidden');
    Travian.ajax({
      data: { cmd: 'donationLimitBar' },
      onSuccess: function (b) {
        a.html(b.limitBar);
        jQuery(window).trigger(
          'domAltered',
          jQuery('#myDailyContributionLimit')
        );
        Travian.Tip.refresh();
  ...
  refreshAllianceBonusOverview: function () {
    var a = jQuery('#allianceBonusOverview'),
      b = this;
    if (!a) {
      return;
    }
    Travian.ajax({
      data: { cmd: 'allianceBonusOverview' },
      onSuccess: function (c) {
        a.html(c.overview);
        b.initBonusOverview();
        Travian.Tip.refresh();
  ...
  refreshDailyDonation: function (f, a, h, l) {
    ...
    var g = r / s;
    k.css({
      transition: 'width ' + r + 'ms, opacity 500ms',
      width: b.toString() + '%',
    });
    var n = 1;
  ...
  initBonusIcons: function () {
    var a = jQuery('#contributionBox').find(
      '#bonusSelection .bonusButtonRound'
    );
    a.off('click');
  ...
  initBonusOverview: function () {
    ...
    try {
      b = JSON.decode(
        Travian.Game.Preferences.get('allianceBonusesOverview') || '{}'
      );
    } catch (d) {
      b = {};
    }
          ...
          setTimeout(function () {
            ...
            setTimeout(function () {
              ...
              setTimeout(function () {
                ...
                setTimeout(function () {
                  d.find('.stoneDisplayHeader .level1 .glow').removeClass(
                    'visible'
                  );
                }, 150);
                if (b >= 2) {
                  setTimeout(function () {
                    d.find('.stoneDisplayHeader .level2 .glow').addClass(
                      'visible'
                    );
                    d.find('.stoneDisplayHeader .level2 .star').addClass(
                      'visible'
                    );
                    setTimeout(function () {
                      d.find('.stoneDisplayHeader .level2 .glow').removeClass(
                        'visible'
                      );
                    }, 150);
                    if (b >= 3) {
                      setTimeout(function () {
                        d.find('.stoneDisplayHeader .level3 .glow').addClass(
                          'visible'
                        );
                        d.find('.stoneDisplayHeader .level3 .star').addClass(
                          'visible'
                        );
                        setTimeout(function () {
                          d.find(
                            '.stoneDisplayHeader .level3 .glow'
                          ).removeClass('visible');
                        }, 250);
                        if (b >= 4) {
                          setTimeout(function () {
                            d.find(
                              '.stoneDisplayHeader .level4 .glow'
                            ).addClass('visible');
                            d.find(
                              '.stoneDisplayHeader .level4 .star'
                            ).addClass('visible');
                            setTimeout(function () {
                              d.find(
                                '.stoneDisplayHeader .level4 .glow'
                            ...
                            if (b >= 5) {
                              setTimeout(function () {
                                d.find(
                                  '.stoneDisplayHeader .level5 .glow'
                                ).addClass('visible');
                                d.find(
                                  '.stoneDisplayHeader .level5 .star'
                                ).addClass('visible');
                                setTimeout(function () {
                                  d.find(
                                    '.stoneDisplayHeader .level5 .glow'
                ...
                setTimeout(
                  function () {
                    d.find('.bonusRepresentation .glow').addClass(
                      'step2 visible'
                    );
                    setTimeout(function () {
                      d.find('.bonusRepresentation .glow').removeClass(
                        'visible'
                      );
...
Travian.Game.AllianceLeave.prototype = Object.create(
  Travian.Dialog.Ajax.prototype
);
...
Travian.Game.PaymentWizard = function (a) {
  ...
  this.options = Travian.Helpers.deepmergeObject(
    {
      ...
      preview: {
        ...
        onShow: function (c) {
          if (
            typeof c.options.preview.resultCached !== 'undefined' &&
            c.options.preview.resultCached === true
          ) {
            c.setContent(
              document.getElementById(c.options.preview.contentElement).html()
            );
            document
              .getElementById(c.options.preview.contentElement)
              .set('html', '');
      ...
      onClose: function (d) {
        ...
        if (
          ...
          typeof b.options.callback === 'function'
        ) {
        ...
        if (
          b.options.data.activeTab === 'buyGold' &&
          b.options.preview.enabled
        ) {
  ...
  this.initialize = function () {
    ...
    e.options.onOpen = function () {
      ...
      if (f.length > 0) {
        f.find('.iconButton.info').attr(
          'title',
          Travian.Translation.get('paymentWizard.infoButtonLabel')
        );
        e.updateInfoButton({
          buttonTextInfo: Travian.Translation.get(
            'paymentWizard.infoButtonLabel'
          ),
          infoIcon: function () {
      ...
      if (
        e.options.data.activeTab === 'buyGold' ||
        e.options.data.activeTab === ''
      ) {
  ...
  this.initializeBuyGoldTab = function () {
    ...
    var m = function (q) {
      ...
      Travian.ajax({
        data: { cmd: 'paymentWizardOpenOffers' },
  ...
  this.initializeEarnGoldTab = function () {
    ...
    var g = function (n) {
      ...
      if (m < 6) {
        var l = Travian.Translation.translate(
          '{earnGoldContentMailSendReceiverCount}'
        ).replace('[RECEIVER_COUNT]', m + 1);
        var o = jQuery(
          '<div class="receiverLine">' +
            l +
            ' <input type="text" class="text" name="receiver[]" /></div>'
        );
    ...
    var h = function (l) {
      ...
      f = true;
      Travian.ajax({
        data: { cmd: 'paymentWizardAdvertisedPersons', page: l },
  ...
  this.initializeProsTab = function () {
    ...
    c.find('.prosButton').each(function (e, f) {
      ...
      f.on('click', function (g) {
        ...
        if (jQuery(this).hasClass('productionboostWood')) {
          jQuery(window).trigger('startWayOfPayment', [
            'productionboostWood',
            'paymentWizard',
          ]);
        } else {
    ...
    c.find('.feature').on('mouseover', function (f) {
      ...
      g.find('.infoArea .premiumFeature')
        .filter('.' + e)
        .show();
      d.lastFeatureName = e;
    });
  ...
  this.openProvider = function (d, c, e, f) {
    window.open(
      '/tgpay.php?product=' + d + '&provider=' + c,
      'tgpay',
      'scrollbars=yes,status=yes,resizable=yes,toolbar=yes,width=' +
        e +
        ',height=' +
        f
    );
...
Travian.Game.PaymentWizard.prototype = Object.create(
  Travian.Dialog.Ajax.prototype
);
...
function ShopUIV2() {
  ...
  this.initialize = function () {
    ...
    b.slidingContentOuterWidthPackage =
      b.slidingContentOuterPackage.getDimensions();
    b.slidingContentOuterWidthPackage = parseInt(
      b.slidingContentOuterWidthPackage.x
    );
    ...
    b.slidingContentInnerPaymentMethods = $$(
      '#paymentMethodsSlider .slidingContentInner'
    )[0];
    b.slidingContentOuterPaymentMethods = $$(
      '#paymentMethodsSlider .slidingContentOuter'
    )[0];
    b.slidingContentOuterWidthPaymentMethods =
      b.slidingContentOuterPaymentMethods.getDimensions();
    b.slidingContentOuterWidthPaymentMethods = parseInt(
      b.slidingContentOuterWidthPaymentMethods.x
    );
    ...
    setTimeout(function () {
      ...
      b.updateResultBox();
      setTimeout(function () {
        $$('#packageSlider .package.hideForLoading').removeClass(
          'hideForLoading'
        );
      }, 500);
    }, 250);
  ...
  this.initializePaymentMethods = function () {
    ...
    var a = parseInt(
      $$('.package.selected input.goldProductId')[0].get('value')
    );
    $$('#paymentMethodsSlider .slidingContent')[0].empty();
    b.updateResultBox();
    Travian.ajax({
      data: { cmd: 'paymentProviders', selectedPackage: a },
      onSuccess: function (d) {
        if (
          typeof $$('#paymentMethodsSlider .slidingContent')[0] === 'undefined'
        ) {
          return false;
        }
        ...
        $$('#paymentMethodsSlider .methodItem').each(function (g) {
          ...
          if (b.selectedPaymentMethod !== false) {
            if (
              parseInt(g.getChildren()[0].get('value')) ==
              ...
              for (var e = 0; e < b.paymentMethodsPages.length; e++) {
                if (b.paymentMethodsPages[e] == g.getParent()) {
                  ...
                  $$('#paymentMethodsSlider .methodsPage')
                    .removeClass('visible')
                    .addClass('hidden');
                  b.paymentMethodsPages[e]
                    .removeClass('hidden')
                    .addClass('visible');
                  if (!b.rtl) {
                    b.slidingContentInnerPaymentMethods.tween(
                      'margin-left',
                      f * -1
                    );
                  } else {
  ...
  this.packageSliderButtonCheck = function () {
    ...
    if (typeof a.goldPackagesPages[0] != 'undefined') {
      ...
      if (
        a.goldPackagesPages[a.goldPackagesPages.length - 1].hasClass('hidden')
      ) {
  ...
  this.paymentMethodsSliderButtonCheck = function () {
    ...
    if (typeof a.paymentMethodsPages[0] != 'undefined') {
      if (a.paymentMethodsPages[0].hasClass('visible')) {
        if (
          !$$('#paymentMethodsSlider .slideArea.area1')[0].hasClass('inactive')
        ) {
      ...
      if (
        a.paymentMethodsPages[a.paymentMethodsPages.length - 1].hasClass(
          'hidden'
        )
      ) {
        if (
          $$('#paymentMethodsSlider .slideArea.area2')[0].hasClass('inactive')
        ) {
          $$('#paymentMethodsSlider .slideArea.area2')[0].removeClass(
            'inactive'
          );
        }
      } else {
  ...
  this.bindEvents = function () {
    ...
    $$('#paymentMethodsSlider .methodItem').addEvent(
      'click',
      a.methodItemClickEvent
    );
    ...
    window.addEvent('shopUIV2RestorePreview', function () {
      ...
      $$('#packageSlider .slideArea > div')
        .removeClass('active')
        .addClass('inactive');
      $$('#paymentMethodsSlider .slideArea > div')
        .removeClass('active')
        .addClass('inactive');
  ...
  this.updateResultBox = function () {
    ...
    $$('.resultBox #packageGoldAmount .goldUnits')[0].set(
      'html',
      $$('.package.selected .goldUnits')[0].get('html')
    );
    $$('.resultBox #goldBalanceNew')[0].set(
      'html',
      parseInt($$('.package.selected .goldUnits')[0].get('html')) +
        parseInt($$('.accountBalance span')[0].get('html'))
    );
    $$('.resultBox #priceToPay')[0].set(
      'html',
      $$('.package.selected .price')[0].get('html')
    );
  ...
  this.saveSelectedPaymentMethod = function () {
    var a = this;
    if ($$('#paymentMethodsSlider .methodItem.selected')[0]) {
      a.selectedPaymentMethod = parseInt(
        $$(
          '#paymentMethodsSlider .methodItem.selected input.providerId'
        )[0].get('value')
      );
    }
  };
  ...
  this.buyNowAction = function () {
    if ($$('#overview .resultBox .inactiveButton.hide')[0]) {
      ...
      var f = 600;
      if (
        $$('#paymentMethodsSlider .methodItem.selected input.popupWidth')[0]
      ) {
        d = $$(
          '#paymentMethodsSlider .methodItem.selected input.popupWidth'
        )[0];
      }
      if (
        $$('#paymentMethodsSlider .methodItem.selected input.popupHeight')[0]
      ) {
        f = $$(
          '#paymentMethodsSlider .methodItem.selected input.popupHeight'
        )[0];
      }
      var a = (screen.width - d) / 2;
      var c = (screen.height - f) / 2;
      window.open(
        '/tgpay.php?product=' + e + '&provider=' + b,
        'tgpay',
        'scrollbars=yes,status=yes,resizable=yes,toolbar=yes,width=' +
          d +
          ',height=' +
  ...
  this.changeLocation = function () {
    ...
    Travian.Game.PaymentWizardEventListener.PaymentWizardObject &&
      Travian.Game.PaymentWizardEventListener.PaymentWizardObject.close();
  ...
  this.request = function () {
    ...
    Travian.ajax({
      ...
      onSuccess: function (d) {
        ...
        c.updateInfoButton({
          buttonTextInfo: Travian.Translation.get(
            'videoFeature.infoButtonLabel'
          ),
          infoIcon: function () {
            window.open(
              jQuery('#videoFeature').find('.videoFeatureAnswersLink').val()
            );
          },
        });
      },
...
Travian.Game.VideoFeatureShowVideo.prototype = Object.create(
  Travian.Dialog.Ajax.prototype
);
Travian.Game.VideoFeatureShowVideo.constructor =
  Travian.Game.VideoFeatureShowVideo;
...
Travian.Game.VideoFeatureInfo.prototype = Object.create(
  Travian.Dialog.Ajax.prototype
);
...
Travian.Game.VideoFeatureAbort.prototype = Object.create(
  Travian.Dialog.Ajax.prototype
);
    ...
    Object.assign(
      {
        ...
        onOkay: function () {
          Travian.Game.Preferences.set(
            'adSalesVideoSuccessDialogDisabled',
            jQuery('input#dontShowThisAgain').is(':checked')
          );
        },
      },
      a
...
Travian.Game.VideoFeatureSuccess.prototype = Object.create(
  Travian.Dialog.Ajax.prototype
);
...
Travian.Game.MoreGames = function (a) {
  ...
  this.events = function () {
    ...
    this.elements.each(function (e, f) {
      jQuery(f).on({
        mouseenter: jQuery.proxy(c, d, e),
        mouseleave: jQuery.proxy(b, d),
      });
    });
    return this;
  };
...
Travian.Game.VideoFeatureEventListener = Object.create({
  ...
  bindEvents: function () {
    ...
    jQuery(window).on('showVideoWindow', function (c, b) {
      if (undefined === a.VideoFeatureObject || null === a.VideoFeatureObject) {
        ...
        a.VideoFeatureObject.options = Object.assign(
          {},
          a.VideoFeatureObject.options,
          b || {}
        );
  ...
  onMessage: function (f, d) {
    if (
      f.originalEvent.origin === 'http://media.oadts.com' ||
      f.originalEvent.origin === 'https://media.oadts.com'
    ) {
      var b = f.originalEvent.data;
      if (b === 'videoStart') {
        Travian.ajax({
          data: { cmd: 'adSalesVideo', action: 'start', vrid: d.vrid },
          onSuccess: function (e) {},
        });
      } else {
        if (b === 'noVideo') {
...
Travian.Game.PaymentWizardEventListener = Object.create({
  ...
  bindEvents: function () {
    ...
    jQuery(window).on('startPaymentWizard', function (c, b) {
      ...
      if (
        undefined === a.PaymentWizardObject ||
        null === a.PaymentWizardObject
      ) {
        a.PaymentWizardObject = a.startPaymentWizard(b);
      } else {
        a.PaymentWizardObject.options = Travian.Helpers.deepmergeObject(
          {},
          a.PaymentWizardObject.options,
          b || {}
        );
...
Travian.Game.WayOfPaymentEventListener = Object.create({
  ...
  bindEvents: function () {
    ...
    jQuery(window).on('buttonClicked', function (d, c, b) {
      if (
        typeof b.wayOfPayment === 'object' &&
        a.DoubleClickPreventer.check()
      ) {
        a.WayOfPaymentObject = a.startWayOfPayment(
          b.wayOfPayment.featureKey,
          b.wayOfPayment.context,
          b.wayOfPayment.dataCallback,
          b.wayOfPayment.confirmPopup,
          b.wayOfPayment.closeAllDialogs
        );
      }
    });
...
Travian.Game.ButtonEventListener = {
  bindEvents: function () {
    jQuery(window).on('buttonClicked', function (c, b, a) {
      jQuery(b).blur();
      if (
        typeof a.dialog === 'object' &&
        a.dialog &&
        Travian.DoubleClickPreventer.globalCheck()
      ) {
        return new Travian.Dialog.Ajax(a.dialog);
      }
      if (
        typeof a.plusDialog === 'object' &&
        a.plusDialog &&
        Travian.DoubleClickPreventer.globalCheck()
      ) {
      ...
      if (
        typeof a.productionBoostDialog === 'object' &&
        a.productionBoostDialog &&
        Travian.DoubleClickPreventer.globalCheck()
      ) {
        return new Travian.Game.ProductionBoostDialog(a.productionBoostDialog);
      }
      if (
        typeof a.reportSpamMessagesDialog === 'object' &&
        a.reportSpamMessagesDialog &&
        Travian.DoubleClickPreventer.globalCheck()
      ) {
        return new Travian.Game.ReportSpamMessagesDialog(
          a.reportSpamMessagesDialog
        );
      }
      if (
        typeof a.goldclubDialog === 'object' &&
        a.goldclubDialog &&
        Travian.DoubleClickPreventer.globalCheck()
      ) {
      ...
      if (
        typeof a.questButtonTipsToggle !== 'undefined' &&
        a.questButtonTipsToggle
      ) {
        if (
          typeof a.questButtonActivateTips !== 'undefined' &&
          a.questButtonActivateTips &&
          typeof a.questButtonDeactivateTips !== 'undefined' &&
          a.questButtonDeactivateTips
        ) {
          return Travian.Game.Quest.toggleHighlights(
            a.questButtonActivateTips,
            a.questButtonDeactivateTips
          );
        }
      ...
      if (
        typeof a.questButtonGainReward !== 'undefined' &&
        a.questButtonGainReward
      ) {
      ...
      if (
        typeof a.questButtonSkipTutorial !== 'undefined' &&
        a.questButtonSkipTutorial
      ) {
        return Travian.Game.Quest.skipButtonClick();
      }
      if (
        typeof a.questButtonOverview !== 'undefined' &&
        a.questButtonOverview
      ) {
        return Travian.Game.Quest.openTodoListDialog();
      }
      if (
        typeof a.questButtonOverviewAchievements !== 'undefined' &&
        a.questButtonOverviewAchievements
      ) {
        return Travian.Game.Quest.openTodoListDialog('', true);
      }
      if (
        typeof a.questButtonCloseOverlay !== 'undefined' &&
        a.questButtonCloseOverlay
      ) {
        return Travian.Game.Quest.closeDialog();
      }
      if (
        typeof a.overlay !== 'undefined' &&
        a.overlay &&
        Travian.DoubleClickPreventer.globalCheck()
      ) {
      ...
      if (
        typeof a.villageDialog !== 'undefined' &&
        a.villageDialog &&
        Travian.DoubleClickPreventer.globalCheck()
      ) {
        return Travian.Game.showEditVillageDialog(
          a.villageDialog.title,
          a.villageDialog.description,
          a.villageDialog.saveText,
          a.villageDialog.villageId
        );
      }
      if (
        typeof a.redirectUrl !== 'undefined' &&
        a.redirectUrl &&
        Travian.DoubleClickPreventer.globalCheck()
      ) {
      ...
      if (
        typeof a.redirectUrlExternal !== 'undefined' &&
        a.redirectUrlExternal &&
        Travian.DoubleClickPreventer.globalCheck()
      ) {
...
Travian.Game.WayOfPayment = function (e, c, d, a, b) {
  ...
  this.initialize = function (k, h, i, f, g) {
    ...
    if (
      typeof i === 'string' &&
      typeof i.split('.').reduce(function (m, l) {
        return m[l];
      }, window) === 'function'
    ) {
  ...
  this.renderDialog = function (f) {
    ...
    if (
      typeof this.closeAllDialogs !== 'undefined' &&
      this.closeAllDialogs !== null &&
  ...
  this.openPaymentWizard = function (h, f) {
    ...
    if (
      typeof h.callback === 'string' &&
      typeof h.callback.split('.').reduce(function (k, j) {
        return k[j];
      }, window) === 'function'
    ) {
...
Travian.Game.PlusDialog = function (a) {
  ...
  this.createContent = function (k, g) {
    ...
    var h = jQuery(
      '<div class="buttonSubTitle">' + g.buttonSubtitle + '</div>'
    );
    o.append(p);
    o.append(h);
    var n = jQuery(
      '<h3 class="extraFeatures">' + g.plusPopupButtonExtraFeatures + '</h3>'
    );
    ...
    jQuery.each(g.features, function (r, q) {
      if (r === l.options.featureKey) {
        i.append(
          jQuery(
            '<div class="feature featureInfo">' +
              l.options.featureMarkup(q.title, q.text, r) +
              '</div>'
          )
        );
      } else {
    ...
    Object.assign(
      {
        ...
        featureMarkup: function (c, b, d) {
          return [
            '<div class="featureImage ' + d + '"></div>',
            '<div class="featureContent">',
            '<h3 class="featureTitle">' + c + '</h3>',
            '<div class="featureText">' + b + '</div>',
            '</div>',
            '<div class="clear"></div>',
          ].join('');
        },
...
Travian.Game.PlusDialog.prototype = Object.create(
  Travian.Dialog.Ajax.prototype
);
...
Travian.Game.GoldclubDialog = function (a) {
  ...
  this.createContent = function (l, h) {
    ...
    var i = jQuery(
      '<div class="buttonSubTitle">' + h.buttonSubtitle + '</div>'
    );
    o.append(p);
    o.append(i);
    var g = jQuery(
      '<h3 class="extraFeatures">' +
        h.goldclubPopupButtonExtraFeatures +
        '</h3>'
    );
    ...
    jQuery.each(h.features, function (r, q) {
      if (r === m.options.featureKey) {
        j.append(
          jQuery(
            '<div class="feature featureInfo">' +
              m.options.featureMarkup(q.title, q.text, r) +
              '</div>'
          )
        );
      } else {
...
Travian.Game.GoldclubDialog.prototype = Object.create(
  Travian.Dialog.Ajax.prototype
);
...
Travian.Game.ProductionBoostDialog = function (a) {
  ...
  this.createContent = function (h, f) {
    ...
    i.append(e);
    var c = jQuery('<h3 class="subHeadLine"></h3>').html(
      f.productionBoostChooseText
    );
    var j = jQuery(
      '<div class="featureCollection" id="featureCollectionWrapper"></div>'
    );
    for (var k in f.features) {
      var g = jQuery('<div class="feature featureBooking">').html(
        h.options.featureMarkup(
          k,
          f.features[k].title,
          f.features[k].subtitle,
          f.features[k].subtitleClassExtension,
          f.features[k].button,
          f.features[k].buttonSubtitle
        )
      );
      j.append(g);
    }
    ...
    Object.assign(
      {
        ...
        featureMarkup: function (e, g, c, b, d, f) {
          return [
            '<div class="featureImage ' + e + '"></div>',
            '<div class="featureContent">',
            '<h3 class="featureTitle productionBoostTitle">' + g + '</h3>',
            '<div class="featureRemainingTime productionBoostSubtitle subtitle ' +
              b +
              '">' +
              c +
              '</div>',
            '<div class="featureButton productionBoostButtonPos">' +
              d +
              '</div>',
            '<div class="featureDuration featureRenewal productionBoostButtonSubtitle subtitle">' +
              f +
              '</div>',
            '</div>',
            '<div class="clear"></div>',
...
Travian.Game.ProductionBoostDialog.prototype = Object.create(
  Travian.Dialog.Ajax.prototype
);
Travian.Game.ProductionBoostDialog.constructor =
  Travian.Game.ProductionBoostDialog;
...
Travian.Game.GoldTransferDialog.prototype = Object.create(
  Travian.Dialog.Ajax.prototype
);
...
Travian.Game.Quest = Object.create({
  ...
  nextButtonClick: function (a) {
    Travian.ajax({
      data: { cmd: 'quest', questTutorialId: a, action: 'next' },
    });
  },
  ...
  toggleHighlights: function (b, a) {
    this.highlightsToggle
      ? this.disableHightlights(b, a)
      : this.enableHighlighs(b, a);
  },
  ...
  openInformationDialog: function (f, a, b) {
    ...
    if (this.dialog[e] === null) {
      ...
      this.dialog[e] = new Travian.Dialog.Ajax({
        ...
        preventFormSubmit: true,
        buttonTextInfo:
          Travian.Translation.get('answers.' + f.toLowerCase() + '_title') ||
          'Answers',
      ...
      this.dialog[e].options.buttonTextInfo =
        Travian.Translation.get('answers.' + f.toLowerCase() + '_title') ||
        'Answers';
  ...
  initializeQuests: function () {
    if (
      this.options.isTutorial &&
      this.options.tutorialData.id === 'Tutorial_01' &&
      Travian.Game.Preferences.get('firstTutorialClosed') !== true
    ) {
      if (Travian.WindowManager.getWindowsByContext('quest').length === 0) {
        this.openInformationDialog(
          this.options.tutorialData.id,
          this.options.tutorialData.answersLink
        );
      }
    }
  },
...
jQuery(function () {
  Travian.Game.Quest.highlightsToggle =
    Travian.Game.Preferences.get('highlightsToggle');
        ...
        if (e.length > 0) {
          Travian.ajax({
            ...
            onSuccess: function (j) {
              if (
                undefined !== j.reportingSuccessful &&
                j.reportingSuccessful
              ) {
  ...
  toggleBuildingLevels: function () {
    ...
    if (b) {
      d.staggerTo(
        '.buildingSlot .level',
        0.3,
        { opacity: 0, marginTop: '20px', ease: Power4.easeOut },
        0.02,
        '+=0',
        function () {
          ...
          d.staggerTo(
            '.buildingSlot .level',
            0.3,
            { opacity: 1, marginTop: 0, ease: Power4.easeOut },
            0.02
          );
        }
      );
      ...
      d.staggerTo(
        ...
        function () {
          a.each(function (e, f) {
            var g = jQuery(f);
            var i = g.html(),
              h = jQuery('<div/>').addClass('labelLayer').html(i);
    ...
    var c = parseInt(Date.now()) + parseInt(d) * 86400000,
      a = function (g, j) {
        var e = function (n) {
          ...
          f = new Date(g.getTime() + g.getTimezoneOffset() * 60000 + j * 1000),
          l = e(f.getDate()),
          i = e(f.getMonth() + 1),
          k = e(f.getFullYear() % 100),
          h = e(f.getHours()),
          m = e(f.getMinutes());
        return l + '.' + i + '.' + k + ', ' + h + ':' + m;
      };
...
Travian.Game.Arifact = {
  setAutoProlongue: function (b, a) {
    Travian.ajax({
      data: { cmd: 'artifact', id: b, action: 'reactivate', state: a ? 1 : 0 },
    });
  },
};
...
Travian.Game.Map.Base.prototype.globalProperties = [
  'cookie',
  'dataStore',
  'transition',
  'updater',
...
Travian.Game.Map.Base.prototype.isCoordinatesInRect = function (a) {
  return (
    this.mapCoordinates.x <= a.x &&
    this.mapCoordinates.y <= a.y &&
    a.x <= this.mapCoordinates.right &&
    a.y <= this.mapCoordinates.top
  );
};
...
Travian.Game.Map.Container = (function () {
  var b = function (e) {
    ...
    var l = function (r, p, t, q) {
      ...
      if (
        e.containerViewSize.x <= p &&
        e.containerViewSize.y <= t &&
        p <= e.containerViewSize.right &&
        t <= e.containerViewSize.bottom &&
        q === e.containerMover.get(0) &&
        !s
      ) {
        h = true;
        d = false;
    ...
    var g = function (q, p, s) {
      if (
        e.containerViewSize.x <= p &&
        e.containerViewSize.y <= s &&
        p <= e.containerViewSize.right &&
        s <= e.containerViewSize.bottom
      ) {
        e.currentMousePosition.browserAbsolute.x = p;
        e.currentMousePosition.browserAbsolute.y = s;
        e.currentMousePosition.browser.x =
          p - e.containerSize.x - e.elementSize.x;
        e.currentMousePosition.browser.y =
          s - e.containerSize.y - e.elementSize.y;
        e.currentMousePosition.map = e.transition.translateToMap(
          e.currentMousePosition.browser,
          {}
        );
      } else {
    ...
    var k = function (q, p, t) {
      ...
      if (
        ...
        !d &&
        h &&
        !Travian.WindowManager.checkOpenWindowByContext('map')
      ) {
        ...
        if (e.tileDisplayInformation.type === 'dialog') {
          new Travian.Dialog.Ajax(
            Object.assign({}, e.tileDisplayInformation.optionsDialog, {
              context: 'map',
              stickToUrlOnRestore: true,
              data: { cmd: 'viewTileDetails', x: r.x, y: r.y },
              onOpen: function (v, u) {
                jQuery(u)
                  .find('a[href^="karte.php"]')
                  .on('click', function (x) {
                    x.preventDefault();
                    var w = Travian.parseURL(x.target.href);
                    e.moveTo({
                      x: parseInt(w.searchObject.x || '0'),
                      y: parseInt(w.searchObject.y || '0'),
                    });
                    v.close();
                    return false;
                  });
          ...
          Travian.popup(
            Travian.Helpers.substitute(
              e.tileDisplayInformation.optionsPopup.url,
              r
            ),
            e.tileDisplayInformation.optionsPopup.windowOptions
          );
        }
      }
    ...
    jQuery(window).on({
      ...
      wheel: function (p) {
        ...
        if (
          e.containerViewSize.x <= p.pageX &&
          e.containerViewSize.y <= p.pageY &&
          p.pageX <= e.containerViewSize.right &&
          p.pageY <= e.containerViewSize.bottom &&
          p.target === e.containerMover.get(0)
        ) {
      ...
      keydown: function (p) {
        ...
        if (
          ...
          p.target.nodeName.toLowerCase() !== 'input'
        ) {
          i.count++;
  ...
  var a = function (c) {
    ...
    this.setContainerSizes = function (i) {
      ...
      this.containerSize = {
        ...
        width:
          Math.ceil(this.containerViewSize.width / this.blockSize.width) *
          this.blockSize.width,
        height:
          Math.ceil(this.containerViewSize.height / this.blockSize.height) *
          this.blockSize.height,
        right:
          this.containerViewSize.x +
          Math.ceil(this.containerViewSize.width / this.blockSize.width) *
            this.blockSize.width,
        bottom:
          this.containerViewSize.y +
          Math.ceil(this.containerViewSize.height / this.blockSize.height) *
            this.blockSize.height,
      };
    };
    this.positionChange = function () {
      var j = Object.assign(
        this.containerRender.getDimensions({ computeSize: true }),
        this.containerRender.getPosition()
      );
      var i = {
        x: this.containerViewSize.x - j.x,
        y: this.containerViewSize.y - j.y,
      };
    ...
    this.updateBrowserURL = function (i) {
      ...
      window.history.replaceState(
        this.savedURL,
        document.title,
        Travian.composeURI(this.savedURL)
      );
    ...
    this.moveTo = function (j) {
      var i = this.transition.translateToBrowser({
        x: Math.floor(j.x),
        y: Math.floor(j.y),
      });
      ...
      return this.move({
        x: this.elementSize.width / 2 - i.x,
        y: -(this.elementSize.height / 2 - i.y),
      });
    };
    ...
    this.render = function () {
      this.container = jQuery('<div/>')
        ...
        .prependTo(this.containerRender);
      this.elementSize = {
        x: -this.blockSize.width * this.blockOverflow,
        y: -this.blockSize.height * this.blockOverflow,
        width:
          this.containerSize.width +
          this.blockSize.width * this.blockOverflow * 2,
        height:
          this.containerSize.height +
          this.blockSize.height * this.blockOverflow * 2,
      };
      ...
      this.containerMover = jQuery('<div/>')
        .css({
          overflow: 'hidden',
          position: 'absolute',
          left: 0,
    ...
    this.renderBlocks = function () {
      ...
      for (var p = 0, n = 0; p < j; p++) {
        for (var q = 0; q < k; q++) {
          ...
          l = { id: n++, version: 0 };
          if (
            this.data.blocks[r.x] &&
            this.data.blocks[r.x][r.y] &&
            this.data.blocks[r.x][r.y][r.right] &&
            this.data.blocks[r.x][r.y][r.right][r.top]
          ) {
            l = Object.assign(
              {},
              l,
          ...
          this.blocks.push(
            new Travian.Game.Map.Layer.Block(
              Object.assign({}, this.options.block, {
                id: l.id,
    ...
    this.zoom = function (k, j) {
      ...
      if (this.transition.zoom(k)) {
        ...
        this.onZoom(this);
        if (
          (T4_feature_flags.territory && i === 3) ||
          this.transition.zoomLevel === 3
        ) {
          this.dataStore.removeAllOfType(
            Travian.Game.Map.DataStore.TYPE_TOOLTIP
          );
        }
        this.moveTo(j);
        if (this.gridDisplayed) {
    ...
    if (this.data.elements) {
      this.dataStore.setMultiple(
        Travian.Game.Map.DataStore.TYPE_TILE,
        this.data.elements
      );
    }
...
Travian.Game.Map.Transition = (function () {
  ...
  var b = function (f) {
    ...
    f.elementsInView = {
      x:
        (f.elementsPerBlock.x * f.mapContainer.containerSize.width) /
        f.mapContainer.blockSize.width,
      y:
        (f.elementsPerBlock.y * f.mapContainer.containerSize.height) /
        f.mapContainer.blockSize.height,
    };
  };
  var d = function (i, g) {
    var h = {
    ...
    return {
      x:
        (g.x - i.positionOrigin.map.x) * i.pixelPerTile.x +
        i.positionOrigin.browser.x -
        h.x,
      y:
        (i.positionOrigin.map.y - g.y) * i.pixelPerTile.y -
        f -
        h.y +
        i.positionOrigin.browser.y,
    };
  };
  var c = function (f, g) {
    ...
    this.getPointOfCenterInView = function () {
      var h = {
        x:
          this.mapContainer.containerViewSize.x +
          this.mapContainer.containerViewSize.width / 2,
        y:
          this.mapContainer.containerViewSize.y +
          this.mapContainer.containerViewSize.height / 2,
      };
    ...
    this.translateToBrowser = function (i) {
      ...
      return {
        x:
          (i.x - this.positionOrigin.map.x) * this.pixelPerTile.x +
          this.positionOrigin.browser.x -
          j.x,
        y:
          (this.positionOrigin.map.y - i.y) * this.pixelPerTile.y -
          h -
          j.y +
          this.positionOrigin.browser.y,
      };
    };
    this.translateToMap = function (j, k) {
      ...
      if (k.round) {
        h = {
          x:
            Math.floor(
              (j.x + l.x - this.positionOrigin.browser.x) / this.pixelPerTile.x
            ) + this.positionOrigin.map.x,
          y:
            this.positionOrigin.map.y -
            Math.floor(
              (j.y + i + (l.y - this.positionOrigin.browser.y)) /
                this.pixelPerTile.y
            ),
        };
      } else {
    ...
    this.zoom = function (j) {
      if (
        j === 0 ||
        (j < 0 && this.zoomLevel + j < 1) ||
        (j > 0 && this.zoomLevel + j > this.zoomOptions.sizes.length)
      ) {
        return false;
      }
      this.zoomLevel += j;
    ...
    this.positionOrigin = {
      browser: {
        ...
        y:
          this.mapContainer.containerSize.y +
          this.mapContainer.containerSize.height,
      },
      map: { x: 0, y: 0 },
    };
    b(this);
...
Travian.Game.Map.Updater = (function () {
  var b = function (i) {
    ...
    i.requestObject.multiple = Travian.ajax({
      url: i.url,
      data: Object.assign({}, i.parameters.multiple, {
        data: g,
        zoomLevel: i.transition.zoomLevel,
      }),
      onSuccess: function (j) {
        i.updateWorking(-1);
  ...
  var a = function (h, g) {
    ...
    var f = {
      x0:
        g.position.x +
        h.options.positionOptions.areaAroundPosition[h.transition.zoomLevel]
          .left,
      y0:
        g.position.y +
        h.options.positionOptions.areaAroundPosition[h.transition.zoomLevel]
    ...
    h.requestObject.position = Travian.ajax({
      url: h.url,
      data: Object.assign({}, h.parameters.position, {
        data: Object.assign({}, g.position, {
          zoomLevel: h.transition.zoomLevel,
          ignorePositions: h.dataStore
            .getPositionsOfData(g.dataStoreType)
            .filter(function (i) {
                    ...
                    for (var k in n.blocks[j][l][i]) {
                      if (n.blocks[j][l][i].hasOwnProperty(k)) {
                        ...
                        var o = Object.assign(
                          {},
                          this.dataStore.get(
                            Travian.Game.Map.DataStore.TYPE_BLOCKS,
                            h,
                            'block'
                          ) || {},
                          n.blocks[j][l][i][k]
...
Travian.Game.Map.ContextMenu = function (a, d) {
  ...
  this.startListener = function () {
    ...
    this.targets.each(function (f, g) {
      jQuery(g).on(e.options.trigger, function (h) {
        if (
          h.target === e.parentContainer.containerMover.get(0) &&
          !e.options.disabled
        ) {
  ...
  this.update = function () {
    ...
    this.contentData = this.parentContainer.dataStore.get(
      Travian.Game.Map.DataStore.TYPE_TOOLTIP,
      this.mapPosition
    );
  ...
  this.targets.each(function (e, f) {
    jQuery(f).on(c.options.trigger, function (g) {
      c.mapPosition = c.parentContainer.transition.translateToMap({
        x:
          g.pageX -
          c.parentContainer.containerSize.x -
          c.parentContainer.elementSize.x,
        y:
          g.pageY -
          c.parentContainer.containerSize.y -
          c.parentContainer.elementSize.y,
      });
      c.update();
    });
  });
...
Travian.Game.Map.DataStore = (function () {
  ...
  var e = function (g) {
    for (var h in g.options.useStorageForType) {
      if (
        g.options.useStorageForType.hasOwnProperty(h) &&
        g.options.useStorageForType[h]
      ) {
        Travian.Storage.set(
          'mapDataContainer.' + h,
          g.data[h],
          g.options.persistentStorage
        );
      }
    }
  };
  ...
  var d = function (g, i, h) {
    return (
      i.time !== false &&
      new Date().getTime() - i.time > g.cachingTimeForType[h]
    );
  };
  var a = function (g, j) {
    ...
    this.getPositionsOfData = function (k) {
      ...
      return Object.keys(this.data[k].all)
        .filter(function (m) {
    ...
    for (i in this.options.clearStorageForType) {
      if (
        this.options.clearStorageForType.hasOwnProperty(i) &&
        this.options.clearStorageForType[i]
      ) {
        Travian.Storage.clear(
          'mapDataContainer.' + i,
          this.options.persistentStorage
        );
      }
    }
    for (i in this.options.useStorageForType) {
      if (
        this.options.useStorageForType.hasOwnProperty(i) &&
        this.options.useStorageForType[i]
      ) {
        this.data[i] =
          Travian.Storage.get(
            'mapDataContainer.' + i,
        ...
        if (!this.data[i].all) {
          ...
          var h = Math.max(
            Object.keys(this.data[i].all).map(function (k) {
              return parseInt(k);
            })
          );
          if (h > f) {
...
Travian.Game.Map.Tips = {
  ...
  lastTitle: '',
  tooltipHtml:
    '<span class="xCoord">({x}</span><span class="pi">|</span><span class="yCoord">{y})</span><span class="clear"></span>',
  render: function (c, a) {
    var b = this;
...
Travian.Game.Map.Rulers = (function () {
  ...
  var f = function (g) {
    g.elements.moverX.css({
      backgroundImage:
        'url(' +
        Travian.Helpers.substitute(g.imgSource.x, {
          zoomLevel: g.transition.zoomLevel,
        }) +
        ')',
    });
    g.elements.moverY.css({
      backgroundImage:
        'url(' +
        Travian.Helpers.substitute(g.imgSource.y, {
          zoomLevel: g.transition.zoomLevel,
        }) +
        ')',
    });
  ...
  var e = function (m) {
    ...
    for (var g = 0, h = null, j = null; g < n; g += l) {
      h = jQuery('<div/>')
        .addClass('coordinate zoom' + m.transition.zoomLevel)
        .css({
          position: 'absolute',
          left:
            (g * m.mapContainer.blockSize.width) /
            m.transition.elementsPerBlock.x,
          top: 0,
          width:
            (l * m.mapContainer.blockSize.width) /
            m.transition.elementsPerBlock.x,
          height: m.containerSize.height,
        })
        .appendTo(m.elements.moverX);
      h.rulerLeft =
        (g * m.mapContainer.blockSize.width) / m.transition.elementsPerBlock.x;
    ...
    for (g = 0, h = null, j = null; g < k; g += i) {
      h = jQuery('<div/>')
        ...
        .css({
          ...
          left: 0,
          top:
            (g * m.mapContainer.blockSize.height) /
            m.transition.elementsPerBlock.y,
          width: m.containerSize.width,
          height:
            (i * m.mapContainer.blockSize.height) /
            m.transition.elementsPerBlock.y,
        })
        .appendTo(m.elements.moverY);
      h.rulerTop =
        (g * m.mapContainer.blockSize.height) / m.transition.elementsPerBlock.y;
  ...
  var d = function (g, h) {
    ...
    this.render = function (i) {
      ...
      this.containerSize = {
        width: this.elements.containerY.width(),
        height: this.elements.containerX.height(),
      };
      ...
      this.elements.moverX = jQuery('<div/>')
        .css({
          position: 'absolute',
          left: 0,
          top: 0,
          width:
            this.mapContainer.containerSize.width +
            2 * this.mapContainer.blockSize.width,
          height: '100%',
          backgroundPosition: 'left top',
          backgroundColor: 'transparent',
      ...
      this.elements.moverY = jQuery('<div/>')
        .css({
          position: 'absolute',
          left: 0,
          top: 0,
          ...
          height:
            this.mapContainer.containerSize.height +
            2 * this.mapContainer.blockSize.height,
          backgroundPosition: 'left top',
          backgroundColor: 'transparent',
...
Travian.Game.Map.MiniMap = (function () {
  var c = function (i) {
    var e = i.transition.translateToMap(
      { x: -i.mapContainer.elementSize.x, y: -i.mapContainer.elementSize.y },
      {}
    );
    ...
    i.elementHelpers[0].css({
      left: f.x,
      bottom: f.y,
      width: f.width,
      height: f.height,
    });
    i.elementHelpers[1].css({
      left: d.x,
      bottom: f.y,
      width: f.width,
      height: f.height,
    });
    i.elementHelpers[2].css({
      left: f.x,
      bottom: d.y,
      width: f.width,
      height: f.height,
  ...
  var b = function (g, f) {
    ...
    return {
      x: Math.floor(
        (g.pageX - f.containerPosition.x) / d.x -
          Math.abs(f.transition.border.left)
      ),
      y: -Math.floor(
        (g.pageY - f.containerPosition.y) / d.y -
          Math.abs(f.transition.border.bottom)
      ),
    };
  };
  var a = function (d, e) {
    ...
    this.animate = function () {
      ...
      var f = function () {
        return !g.expanded
          ? g.elements.container._height.min
          : g.elements.container._height.max;
      };
      ...
      this.parentContainer.outline.update(
        this.elements.container.height() - f()
      );
      return this;
    };
    ...
    this.render = function (h) {
      ...
      jQuery('<div/>')
        .addClass('inner')
        .css({ height: '100%', opacity: 0.25, width: '100%' })
      ...
      this.elements.headlineExpander.addClass(
        this.expanded === true ? 'collapse' : 'expand'
      );
      var l = function () {
        k.elements.container._height = {
          max: k.elements.container.height(),
          min:
            k.elements.headline.height() +
            parseInt(k.elements.headline.css('margin-top')) +
            parseInt(k.elements.headline.css('margin-bottom')),
        };
        if (k.expanded !== true) {
          k.elements.container.css({
            height: k.elements.container._height.min,
          });
        }
...
Travian.Game.Map.Toolbar = function (a, b) {
  ...
  this.render = function (c) {
    ...
    this.zoomIn = this.element
      .find('.iconButton.zoomIn')
      .on('click', function (g) {
        f.mapContainer.zoomIn();
      });
    this.zoomOut = this.element
      .find('.iconButton.zoomOut')
      .on('click', function (g) {
        f.mapContainer.zoomOut();
      });
    var e = function () {
      f.zoomDropDownDataContainer._dropped = false;
      f.zoomDropDownDataContainer.css({
        height: f.zoomDropDownDataContainer._styleBackup.height,
      });
      ...
      jQuery(f.zoomDropDownEntries[f.transition.zoomLevel - 1])
        .removeClass('hide')
        .addClass('display');
    };
    this.zoomDropDownDataContainer = this.element.find(
    ...
    this.zoomDropDownClick = this.element
      .find('.dropdown .iconButton.dropDownImage')
      .on('click', function (g) {
        ...
        f.zoomDropDownDataContainer.css({
          height: f.zoomDropDownDataContainer._styleBackup.maxHeight,
        });
      });
    this.zoomDropDownEntries.each(function (g, i) {
      ...
      h.on('click', function (j) {
        ...
        f.mapContainer.zoom(
          g + 1 - f.mapContainer.transition.zoomLevel,
          f.mapContainer.transition.getPointOfCenterInView()
        );
      });
    });
    jQuery('body').on('click', function () {
    ...
    if (d.length > 0) {
      this.viewFull = d.on('click', function (g) {
        window.location.href = Travian.Helpers.substitute(
          f.viewFullScreenUrl,
          Object.assign(
            {},
            f.mapContainer.transition.getPointOfCenterInView(),
            { zoom: f.mapContainer.transition.zoomLevel }
          )
        );
      });
    }
    ...
    if (d.length > 0) {
      this.viewNormal = this.element
        .find('.iconButton.viewNormal')
        .on('click', function (g) {
          window.location.href = Travian.Helpers.substitute(
            f.viewNormalUrl,
            Object.assign(
    ...
    this.filterPlayer = this.element
      .find('.iconButton.filterMy')
      .on('click', function (g) {
        Travian.ajax({
          data: {
            cmd: 'mapSetting',
            data: { type: 'outline', outline: 'user' },
          },
          onSuccess: function (h) {
    ...
    if (!this.filterAlliance.hasClass('disabled')) {
      this.filterAlliance.on('click', function (g) {
        Travian.ajax({
          data: {
            cmd: 'mapSetting',
            data: { type: 'outline', outline: 'alliance' },
          },
          onSuccess: function (h) {
  ...
  this.update = function () {
    ...
    if (this.transition.zoomLevel === 1) {
      ...
      if (
        this.transition.zoomLevel === this.transition.zoomOptions.sizes.length
      ) {
    ...
    jQuery(this.zoomDropDownEntries[this.transition.zoomLevel - 1])
      .removeClass('hide')
      .addClass(
        this.zoomDropDownDataContainer._dropped ? 'selected' : 'display'
      );
  };
  this.zoom = function () {
    this.update();
...
Travian.Game.Map.Toolbar.prototype = Object.create(
  Travian.Game.Map.Base.prototype
);
  ...
  var a = function (b, c) {
    ...
    this.animate = function () {
      ...
      if (this.expanded === false) {
        ...
        this.elements.headlineExpander
          .removeClass('expand')
          .addClass('collapse');
        this.element.animate(
          { height: this.element._height.max },
          200,
          function () {
        ...
        this.elements.headlineExpander
          ...
          .addClass('expand');
        this.element.animate(
          { height: this.element._height.min },
          200,
          function () {
    ...
    this.render = function (d) {
      ...
      var f = function () {
        e.element._height = {
          max:
            e.parentContainer.containerViewSize.height -
            parseInt(e.element.css('bottom')) -
            e.parentContainer.miniMap.elements.container.height() -
            2,
...
Travian.Game.Map.Layer.prototype = Object.create(
  Travian.Game.Map.Base.prototype
);
...
Travian.Game.Map.Layer.Block = (function () {
  var g = function (l, k, j) {
    ...
    if (typeof k.text === 'undefined' && typeof k.title === 'undefined') {
      k.text = Travian.Helpers.substitute(l.tooltipHtml, {
        x: k.position.x,
        y: k.position.y,
      });
    }
  ...
  var i = function (n, q) {
    ...
    var w = {
      x:
        n.transition.border.right - Math.abs(p.x) <
        n.transition.border.right / 2,
      y: n.transition.border.top - Math.abs(p.y) < n.transition.border.top / 2,
    };
    var o = {
      x:
        n.transition.border.right - Math.abs(s.x) <
        n.transition.border.right / 2,
      y: n.transition.border.top - Math.abs(s.y) < n.transition.border.top / 2,
    };
    var v = {
      x:
        n.transition.border.right - Math.abs(m.x) <
        n.transition.border.right / 2,
    ...
    return {
      ...
      y:
        (n.transition.elementsPerBlock.y - (p.y - m.y) - 1) *
        n.transition.pixelPerTile.y,
    };
  };
  var d = function (o, m) {
    if (!m.type) {
  ...
  var e = function (k) {
    c(k);
    var j = k.dataStore.getDataForArea(
      Travian.Game.Map.DataStore.TYPE_SYMBOL,
      k.mapCoordinates,
      true
    );
  ...
  var h = function (o, j, n) {
    ...
    if (
      j.x === o.mapContainer.currentMousePosition.map.x &&
      j.y === o.mapContainer.currentMousePosition.map.y
    ) {
      o.mapContainer.contextMenu.update();
      var m = Object.assign(
        { unescaped: true },
        o.dataStore.get(Travian.Game.Map.DataStore.TYPE_TOOLTIP, j)
      );
  ...
  var a = function (l, j, k) {
    if (
      l.mapContainer.currentMousePosition.map.x == null ||
      l.mapContainer.currentMousePosition.map.y == null
    ) {
      return;
    }
    if (
      j.x !== l.mapContainer.currentMousePosition.map.x ||
      j.y !== l.mapContainer.currentMousePosition.map.y
    ) {
      return;
    }
    l.mapContainer.containerMover.setTitle({
      title: '',
      text: Travian.Helpers.substitute('{x}|{y}', j),
    });
  };
  var b = function (j, k) {
    ...
    this.deleteSymbol = function (l) {
      if (
        !this.symbols ||
        !this.symbols[l.position.x] ||
        !this.symbols[l.position.x][l.position.y]
      ) {
        return this;
      }
    ...
    this.getContentForTooltip = function (l) {
      ...
      if (n != null && (n.text !== undefined || n.title !== undefined)) {
        ...
        n = {
          title: '',
          text: Travian.Translation.translate(this.tooltipHtml, m),
        };
    ...
    this.move = function (m) {
      ...
      this.position.x += m.x;
      this.position.y -= m.y;
      var l = Travian.Game.Map.Layer.Block.getCorrectPosition(
        this.position,
        this.mapContainer
      );
    ...
    this.render = function (l) {
      ...
      this.mapCoordinates = this.transition
        .registerCallbackOnZoom(function () {
...
Travian.Game.Map.Layer.Image = function (a, b) {
  ...
  this.getPriority = function () {
    var e = {
      x:
        this.blockContainer.mapCoordinates.x +
        (this.blockContainer.mapCoordinates.right -
          this.blockContainer.mapCoordinates.x) /
          2,
      y:
        this.blockContainer.mapCoordinates.y +
        (this.blockContainer.mapCoordinates.top -
          this.blockContainer.mapCoordinates.y) /
          2,
    };
  ...
  this.render = function (c) {
    Travian.Game.Map.Layer.prototype.render.call(this, {
      nodeType: '<img src="' + this.srcInit + '">',
    });
...
Travian.Game.Map.Layer.Image.prototype = Object.create(
  Travian.Game.Map.Layer.prototype
);
Travian.Game.Map.Layer.Image.constructor = Travian.Game.Map.Layer.Image;
Travian.Game.Map.Layer.Image.prototype.classType =
  'Travian.Game.Map.Layer.Image';
...
Travian.Game.Map.Layer.ImageMark.prototype = Object.create(
  Travian.Game.Map.Layer.Image.prototype
);
...
Travian.Game.Map.Layer.Loading.prototype = Object.create(
  Travian.Game.Map.Layer.prototype
);
...
Travian.Game.Map.Layer.Symbol.prototype = Object.create(
  Travian.Game.Map.Layer.prototype
);
Travian.Game.Map.Layer.constructor = Travian.Game.Map.Layer;
Travian.Game.Map.Layer.Symbol.prototype.classType =
  'Travian.Game.Map.Layer.Symbol';
...
Travian.Game.Map.Layer.Symbol.Flag.prototype = Object.create(
  Travian.Game.Map.Layer.Symbol.prototype
);
...
Travian.Game.Map.Layer.Symbol.Attack.prototype = Object.create(
  Travian.Game.Map.Layer.Symbol.prototype
);
Travian.Game.Map.Layer.Symbol.Attack.constructor =
  Travian.Game.Map.Layer.Symbol;
...
Travian.Game.Map.Layer.Symbol.BattleGround.prototype = Object.create(
  Travian.Game.Map.Layer.Symbol.prototype
);
Travian.Game.Map.Layer.Symbol.BattleGround.constructor =
  Travian.Game.Map.Layer.Symbol.BattleGround;
Travian.Game.Map.Layer.Symbol.Adventure = function (a, b) {
  this.classType = 'Travian.Game.Map.Layer.Symbol.Adventure';
  this.render = function (c) {
    this.position = {
      x:
        this.positionOfTile.x +
        this.transition.pixelPerTile.x -
        this.position.width,
      y:
        this.positionOfTile.y +
        this.transition.pixelPerTile.y -
...
Travian.Game.Map.Layer.Symbol.Adventure.prototype = Object.create(
  Travian.Game.Map.Layer.Symbol.prototype
);
Travian.Game.Map.Layer.Symbol.Adventure.constructor =
  Travian.Game.Map.Layer.Symbol.Adventure;
...
Travian.Game.Map.Layer.Symbol.Reinforcement.prototype = Object.create(
  Travian.Game.Map.Layer.Symbol.prototype
);
Travian.Game.Map.Layer.Symbol.Reinforcement.constructor =
  Travian.Game.Map.Layer.Symbol.Reinforcement;
  ...
  this.update = function () {
    ...
    for (var e in this.layers) {
      if (this.layers.hasOwnProperty(e)) {
        var d = this.layers[e];
        g.push({
          data: d.elements.data,
          expandContainer: d.elements.expandContainer,
          expanded: d.expanded,
        });
...
Travian.Game.Map.MapMark.prototype = Object.create(
  Travian.Game.Map.Base.prototype
);
Travian.Game.Map.MapMark.constructor = Travian.Game.Map.MapMark;
Travian.Game.Map.MapMark.Layer = function (b, c) {
  Travian.Game.Map.Base.call(this, b, c);
  var a = this.cookie.get(
    'markLayer-' + this.parentContainer.typeId + '-' + this.typeId + '-expanded'
  );
  if (a != null) {
    this.expanded = a;
  }
...
Travian.Game.Map.MapMark.Layer.prototype = Object.create(
  Travian.Game.Map.Base.prototype
);
Travian.Game.Map.MapMark.Layer.constructor = Travian.Game.Map.MapMark.Layer;
Travian.Game.Map.MapMark.Layer.prototype.classType =
  'Travian.Game.Map.MapMark.Layer';
...
Travian.Game.Map.MapMark.Layer.Mark = function (a, c) {
  ...
  this.addData = function (d) {
    var e = new Travian.Game.Map.MapMark.Layer.Data.Mark(
      Object.assign({}, d, this.optionsData, { editable: this.editable }),
      this
    );
    this.datas[e.id] = e;
    return this;
  ...
  this.showDialog = function (d) {
    ...
    this.dialogInstance = new Travian.Dialog.Dialog({
      ...
      elementFocus:
        d.position.x === ''
          ? this.dialog.elementFocusNew
          : this.dialog.elementFocusEdit,
        ...
        d.onOkay(
          {
            color: f.color,
            position: {
              x: h.find('input.inputX').val(),
              y: h.find('input.inputY').val(),
            },
          },
          g,
          h
...
Travian.Game.Map.MapMark.Layer.Mark.prototype = Object.create(
  Travian.Game.Map.MapMark.Layer.prototype
);
Travian.Game.Map.MapMark.Layer.Mark.constructor =
  Travian.Game.Map.MapMark.Layer;
Travian.Game.Map.MapMark.Layer.Flag = function (a, c) {
  ...
  this.addData = function (e) {
    var d = new Travian.Game.Map.MapMark.Layer.Data.Flag(
      Object.assign({}, e, this.optionsData, { editable: this.editable }),
      this
    );
    this.datas[d.id] = d;
    return this;
  ...
  for (var b = this.indexes.min; b <= this.indexes.max; b++) {
    this.imagesArray.push(
      Travian.Helpers.substitute(this.imgSource, { index: b })
    );
  }
};
Travian.Game.Map.MapMark.Layer.Flag.prototype = Object.create(
  Travian.Game.Map.MapMark.Layer.prototype
);
Travian.Game.Map.MapMark.Layer.Flag.constructor =
  Travian.Game.Map.MapMark.Layer;
Travian.Game.Map.MapMark.Layer.Data = function (a, b) {
  Travian.Game.Map.MapMark.Layer.call(this, a, b);
};
Travian.Game.Map.MapMark.Layer.Data.prototype = Object.create(
  Travian.Game.Map.MapMark.Layer.prototype
);
Travian.Game.Map.MapMark.Layer.Data.constructor =
  Travian.Game.Map.MapMark.Layer;
Travian.Game.Map.MapMark.Layer.Data.prototype.classType =
  'Travian.Game.Map.MapMark.Layer.Data';
...
Travian.Game.Map.MapMark.Layer.Data.Mark = (function () {
  var a = function (c) {
    c.elements.color.css({
      backgroundColor: c.parentContainer.colors[c.color],
    });
  };
  var b = function (c, d) {
    ...
    this.render = function (e) {
      ...
      if (this.elements.urlLink) {
        this.elements.urlLink.href = Travian.Helpers.substitute(this.urlLink, {
          markId: this.markId,
        });
      }
      if (this.editable) {
    ...
    this.setColor = function (e) {
      ...
      Travian.ajax({
        ...
        onError: function (h, g) {
          f.parentContainer.dialogInstance
            .enableForm()
            .toElement()
            .find('.errorMessage')
            .html(g);
...
Travian.Game.Map.MapMark.Layer.Data.Flag = (function () {
  var a = function (c) {
    ...
    c.elements.index.html(
      '<img src="' +
        Travian.Helpers.substitute(c.parentContainer.imgSource, {
          index: c.index,
        }) +
        '" alt="" />'
    );
...
Travian.Game.Map.Options.Symbols = {
  ...
  battleGround: {
    ...
    imgSource:
      'img/map/battleground/battleground-{center}-{north}-{east}-{south}-{west}-{width}x{height}.png',
    zIndex: 9,
    visibleInZoom: { 1: true, 2: true, 3: false, 4: false },
    sizes: {
      1: { width: 16, height: 16 },
...
Travian.Game.Map.Options.MapMark.Flag = {
  ...
  imgSource: Travian.Helpers.substitute(
    Travian.Game.Map.Options.Symbols.flag.imgSource,
    { index: '{index}', zoomLevel: 1, width: 16, height: 16 }
  ),
  html: '<div class="title">{title} <a href="#" class="add {add}">+</a></div><div class="iconButton {expandButton} small"></div><div class="clear"></div><div class="{expandContainer}"><div class="{data}"></div></div>',
  dialog: {
    title: '',
...
Travian.Game.Map.Options.Default = {
  ...
  tileDisplayInformation: {
    ...
    optionsDialog: {
      buttonOk: false,
      data: { cmd: 'viewTileDetails', x: null, y: null },
    },
  },
  blockOverflow: 1,
  ...
  onRender: function (c) {
    ...
    c.rulers.render();
    c.miniMap = new Travian.Game.Map.MiniMap(
      Travian.Game.Map.Options.MiniMap,
      c
    );
    c.miniMap.render();
    ...
    c.outline = new Travian.Game.Map.Outline(
      Travian.Game.Map.Options.Outline,
      c
    );
    c.toolbar = new Travian.Game.Map.Toolbar(
      Travian.Game.Map.Options.Toolbar,
      c
    );
    c.toolbar.render();
  ...
  actions: [
    {
      ...
      fn: function (c, b, a) {
        window.location.href =
          'build.php?gid=16&tt=2&x=' + a.position.x + '&y=' + a.position.y;
      },
    },
    {
      ...
      fn: function (c, b, a) {
        window.location.href =
          'build.php?gid=17&t=5&x=' + a.position.x + '&y=' + a.position.y;
      },
    },
    {
...
Travian.Game.Map.Options.Default.block = {
  tooltipHtml:
    '<span class="xCoord">({x}</span><span class="pi">|</span><span class="yCoord">{y})</span><span class="clear"></span><br />{k.loadingData}',
};
    ...
    layers: {
      alliance: Object.assign({}, Travian.Game.Map.Options.MapMark.Mark, {
        ...
        optionsData: Object.assign(
          {},
          Travian.Game.Map.Options.MapMark.Mark.optionsData,
          { urlLink: 'allianz.php?aid={markId}' }
        ),
      }),
      player: Object.assign({}, Travian.Game.Map.Options.MapMark.Mark, {
        typeId: 'player',
      }),
      flag: Object.assign({}, Travian.Game.Map.Options.MapMark.Flag, {
        indexes: { min: 1, max: 10 },
      }),
    },
  },
  alliance: {
