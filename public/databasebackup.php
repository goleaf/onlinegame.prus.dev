...
define('DB_USER', 'root');
define('DB_PASSWORD', '');
define('DB_NAME', 'securimage');
define('DB_HOST', 'localhost');
define('BACKUP_DIR', 'DB_backup'); // Comment this line to use same script's directory ('.')
define('TABLES', '*'); // Full backup
// define("TABLES", 'table1, table2, table3'); // Partial backup
define('IGNORE_TABLES', [
    'tbl_token_auth',
    'token_auth',
]); // Tables to ignore
define('CHARSET', 'utf8');
...
define('BATCH_SIZE', 100000); // Batch size when selecting rows from database in order to not exhaust system memory
