...
Ee.Balancing = {
  units: {
    hero: {
      party: 0,
      health: 100,
      offense: Math.floor(65 + Math.random() * 11) / 10,
      clickBonus: 0,
      hitChance: 50,
      speed: 18,
      jumpInElement: '#heroImageButton img.heroImage',
      picture: '/hero_body.php?uid={uid}&size=profile'.substitute(
        jQuery('#heroImageButton').down('.heroImage').src.fromQueryString()
      ),
    },
    unit00: {
      party: 1,
      ...
      hitChance: 10,
      speed: 9,
      jumpInElement: '#unitRowAtTown td.uniticon.t1 img',
      picture: '/js/Game/Logout/Ee/img/t01.gif',
    },
    unit01: {
      party: 1,
      health: 100,
      ...
      hitChance: 10,
      speed: 9,
      jumpInElement: '#unitRowAtTown td.uniticon.t2 img',
      picture: '/js/Game/Logout/Ee/img/t02.gif',
    },
    unit02: {
      party: 1,
      health: 100,
      ...
      hitChance: 10,
      speed: 9,
      jumpInElement: '#unitRowAtTown td.uniticon.t3 img',
      picture: '/js/Game/Logout/Ee/img/t03.gif',
    },
    unit03: {
      party: 1,
      health: 100,
      ...
      hitChance: 10,
      speed: 9,
      jumpInElement: '#unitRowAtTown td.uniticon.t4 img',
      picture: '/js/Game/Logout/Ee/img/t04.gif',
    },
    unit04: {
      party: 1,
      health: 100,
      ...
      hitChance: 10,
      speed: 9,
      jumpInElement: '#unitRowAtTown td.uniticon.t5 img',
      picture: '/js/Game/Logout/Ee/img/t05.gif',
    },
    unit05: {
      party: 1,
      health: 100,
      ...
      hitChance: 10,
      speed: 9,
      jumpInElement: '#unitRowAtTown td.uniticon.t6 img',
      picture: '/js/Game/Logout/Ee/img/t06.gif',
    },
    unit06: {
      party: 1,
      health: 100,
      ...
      hitChance: 10,
      speed: 9,
      jumpInElement: '#unitRowAtTown td.uniticon.t7 img',
      picture: '/js/Game/Logout/Ee/img/t07.gif',
    },
    unit07: {
      party: 1,
      health: 100,
      ...
      hitChance: 10,
      speed: 9,
      jumpInElement: '#unitRowAtTown td.uniticon.t8 img',
      picture: '/js/Game/Logout/Ee/img/t08.gif',
    },
    unit08: {
      party: 1,
      health: 100,
      ...
      hitChance: 10,
      speed: 9,
      jumpInElement: '#unitRowAtTown td.uniticon.t9 img',
      picture: '/js/Game/Logout/Ee/img/t09.gif',
    },
    unit09: {
      party: 1,
      health: 100,
      ...
      hitChance: 10,
      speed: 9,
      jumpInElement: '#unitRowAtTown td.uniticon.t10 img',
      picture: '/js/Game/Logout/Ee/img/t10.gif',
    },
    unit10: {
      party: 1,
      health: 100,
      ...
      hitChance: 10,
      speed: 9,
      jumpInElement: '#unitRowAtTown td.uniticon.t11 img',
      picture: '/js/Game/Logout/Ee/img/t11.gif',
    },
...
Ee.prototype.finish = function (unitsWinner) {
  ...
  // zu ende oder weiter
  if (
    !Ee.Balancing.parties[unitsWinner.id] ||
    !Ee.Balancing.parties[unitsWinner.id].attackInterface
  ) {
