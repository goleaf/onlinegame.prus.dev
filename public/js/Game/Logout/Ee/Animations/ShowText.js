 ...
 * @returns {Ee.Animations.ShowText}
 */
Ee.Animations.ShowText.prototype.start =
  Ee.Animations.ShowText.prototype.start.wrap(function (proceed) {
    var self = this;
    ...
    var position = {
      left:
        scroll.x + positionRelative.x + sizeRelative.x / 2 - elementSize.x / 2,
      top:
        scroll.y + positionRelative.y + sizeRelative.y / 2 - elementSize.y / 2,
    };
