 ...
 * @returns {Ee.Animations.JumpIn}
 */
Ee.Animations.JumpIn.prototype.start =
  Ee.Animations.JumpIn.prototype.start.wrap(function (proceed) {
    var self = this;
    ...
    var position = {
      left: Ee.Math.random(
        positionToFindIn.x,
        positionToFindIn.x + sizeToFindIn.x
      ),
      top: Ee.Math.random(
        positionToFindIn.y,
        positionToFindIn.y + sizeToFindIn.y
      ),
    };
